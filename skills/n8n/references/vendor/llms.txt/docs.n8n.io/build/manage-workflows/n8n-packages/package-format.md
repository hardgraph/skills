> For the complete documentation index, see [llms.txt](https://docs.n8n.io/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.n8n.io/build/manage-workflows/n8n-packages/package-format.md).
...
An [n8n package](/build/manage-workflows/n8n-packages.md) is a gzip-compressed tar archive. Standard tools read it, so you can inspect one without n8n:
...
* [Export a package](/build/manage-workflows/n8n-packages/export-a-package.md) for how to produce each of the three shapes.
* [Import a package](/build/manage-workflows/n8n-packages/import-a-package.md) for the options that control where the contents land.
* [How import works](/build/manage-workflows/n8n-packages/how-import-works.md) for what n8n does with each entity file.
