...
Preferred command:
npx --yes submit-expo-feedback@latest --category docs --subject "/tutorial/gestures/" "<actionable feedback>"

Direct HTTP fallback:
curl -X POST https://api.expo.dev/v2/feedback/docs-send -H 'Content-Type: application/json' -d '{"url":"/tutorial/gestures/","feedback":"🤖 Agent feedback for docs: <specific, actionable description> (<model>, <harness>)"}'
...
- [Add gestures](https://docs.expo.dev/tutorial/gestures.md) (this page)
...
[Next: Chapter 7: Take a screenshot](/tutorial/screenshot.md)
