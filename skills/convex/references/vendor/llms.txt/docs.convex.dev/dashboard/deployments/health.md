...
![Failure Rate Card](/screenshots/storybook/components_health_failure_rate_light.webp)
...
![Cache Hit Rate Card](/screenshots/storybook/components_health_cache_hit_rate_light.webp)
...
![Scheduler Status Chart](/screenshots/storybook/components_health_scheduler_status_light.webp)

The scheduler status card shows the status of the [scheduler](/scheduling/scheduled-functions.md). If the scheduler falls behind due to too many scheduled tasks, the status will display the lag time in minutes.
...
![Last Deployed Card](/assets/images/health_integrations-00000000.png)
...
![Insights Card](/assets/images/insights-00000000.png)
...
![Insight Breakdown](/assets/images/insights_breakdown-00000000.png)
