...
Preferred command:
npx --yes submit-expo-feedback@latest --category docs --subject "/guides/using-sentry/" "<actionable feedback>"

Direct HTTP fallback:
curl -X POST https://api.expo.dev/v2/feedback/docs-send -H 'Content-Type: application/json' -d '{"url":"/guides/using-sentry/","feedback":"🤖 Agent feedback for docs: <specific, actionable description> (<model>, <harness>)"}'
...
- [Using Sentry](https://docs.expo.dev/guides/using-sentry.md) (this page)
...
-   [Install and configure Sentry](/guides/using-sentry.md#install-and-configure-sentry) in your React Native app
    
-   Using Sentry with EAS:
    
    -   [EAS Build](/guides/using-sentry.md#usage-with-eas-build) for building your app
    -   [EAS Update](/guides/using-sentry.md#usage-with-eas-update) for over-the-air updates
-   [Setting up the Sentry-Expo integration](/guides/using-sentry.md#sentry-integration-with-eas-dashboard) to view crash reports and session replays directly in your EAS dashboard
