...
- [Adapter contract](/docs/runtimes/concepts/adapters#attachment-adapter) — The full AttachmentAdapter type and lifecycle states.
- [Custom thread persistence](/docs/integrations/persistence/custom-adapter) — Round-trip URLs through the message store so attachments survive reloads.