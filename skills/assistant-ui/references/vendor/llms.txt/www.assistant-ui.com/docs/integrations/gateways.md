...
URL: /docs/integrations/gateways

Route AI chat traffic through OpenAI-compatible LLM gateways (OpenRouter, LiteLLM, Portkey, etc.) for cost, fallback, and BYOK in assistant-ui apps.
...
- [Helicone](/docs/integrations/observability/helicone) — The observability-first proxy. Same shape, different goal.
- [AI SDK runtime](/docs/runtimes/ai-sdk/v7) — The runtime that ferries gateway responses to the chat UI.