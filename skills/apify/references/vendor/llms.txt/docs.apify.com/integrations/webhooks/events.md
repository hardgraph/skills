...
url: https://docs.apify.com/integrations/webhooks/events.md
parents:
...
previous: [Ad-hoc webhooks](https://docs.apify.com/integrations/webhooks/ad-hoc-webhooks.md)
next: [AI](https://docs.apify.com/integrations/ai.md)
---
...
Apart from the event data, actions also have the `resource` object available, which can provide more details about the object that triggered the event. For more information about the `resource` objects, see the [Webhooks Actions page](https://docs.apify.com/integrations/webhooks/actions.md#resource)
