> For the complete documentation index, see [llms.txt](https://docs.n8n.io/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.n8n.io/changelog/release-notes-1.x.md).
...
You can find the release notes for older versions of n8n [here](/changelog/release-notes-0.x.md)
{% endhint %}
...
<img src="/files/yuxhWRQfD7k42jbhXpiq" alt="Project roles is now available in the settings of your n8n Enterprise instance." data-size="original">
...
For [OIDC](/administer/manage-users-and-access/verify-user-identity/use-oidc/set-up-oidc.md#instance-and-project-access-provisioning) For [SAML](/administer/manage-users-and-access/verify-user-identity/use-saml/set-up-saml.md#instance-and-project-access-provisioning)
...
* Enterprise customers using Single Sign On via SAML or OIDC can now provision the instance role and project role of each user in their organisation from their Identity Provider.
  * See the [new SAML documentation](/administer/manage-users-and-access/verify-user-identity/use-saml/set-up-saml.md#instance-and-project-access-provisioning)
  * See the [new OIDC documentation](/administer/manage-users-and-access/verify-user-identity/use-oidc/set-up-oidc.md#instance-and-project-access-provisioning)
...
\
\
This feature simplifies integration and improves visibility across AI platforms that support MCP, helping you use your n8n workflows directly in the tools where you already work and experiment. [Learn more in documentation.](/connect/connect-to-n8n-mcp-server.md)<br>

<img src="/files/RCDBvKnTph20kn4ESF3s" alt="Enable MCP for an instance in instance settings." data-size="original">\ <img src="/files/bjx5mpU6JTBZhpcbXbVr" alt="Enable MCP for each workflow in workflow settings." data-size="original">
{% endhint %}
...
The MCP Client Tool now supports OAuth authentication, enabling secure connections to APIs that implement delegated access flows. [Learn more](/integrations/builtin/cluster-nodes/sub-nodes/n8n-nodes-langchain.toolmcp.md) about the MCP Client Tool node.<br>

<img src="/files/mUBdfYeYRCqjhXol0Z5X" alt="Authentication options in MCP Client Tool node" data-size="original"><br>
{% endhint %}
...
For details, see [Export entities](/deploy/host-n8n/configure-n8n/use-the-command-line.md#export-entities)\
...
For details, see [Import entities](/deploy/host-n8n/configure-n8n/use-the-command-line.md#import-entities)
{% endhint %}
...
<figure><img src="/files/JOWwmS4PVEqGxb9PcHEE" alt=""><figcaption><p>HTTPS is now supported as a connection type in Environments.</p></figcaption></figure>
...
Learn more about [**data tables**](/build/work-with-data/data-tables.md) and the [**Data table node**](/integrations/builtin/core-nodes/n8n-nodes-base.datatable.md).
{% endhint %}
...
<figure><img src="/files/nrBW7mAUzthkDuTenQ6r" alt=""><figcaption><p>Filter insights</p></figcaption></figure>
...
<figure><img src="/files/JbVg1pPSA5Af3PrdftSY" alt=""><figcaption><p>Workflow diff</p></figcaption></figure>
...
[Workflow Diff](/administer/use-source-control-and-environments/compare-versions.md) gives you an easy and visual way to review workflow changes before you deploy them between environments.
...
<figure><img src="/files/ioZH9j0lkXFo0rKSLfmo" alt=""><figcaption></figcaption></figure>

<br>

<figure><img src="/files/k8Ymu21T1v2n7tXFuAJa" alt=""><figcaption><p>Workflow Diff</p></figcaption></figure>
...
<figure><img src="/files/hF8vZ9jldJASPwVp0uw4" alt=""><figcaption></figcaption></figure>
...
1. Set up your evaluation as described [here](/build/integrate-ai/test-and-improve-ai-workflows/use-metrics-to-measure-quality.md#how-it-works), using an **Evaluation** node as the trigger and another with the **Set Metrics** operation.
...
\ <img src="/files/vTCVE9N2kWyYB64XDO9n" alt="Built-in Metrics" data-size="original"><br>

[Learn more](/build/integrate-ai/test-and-improve-ai-workflows/understand-why-to-test.md) about setting up and customizing evaluations.
{% endhint %}
...
<figure><img src="/files/NKjJDIVJQ5ZZhpePUZIE" alt=""><figcaption><p>AI Agent Tool node</p></figcaption></figure>
...
<figure><img src="/files/6rPblUHp2liYprzdwofq" alt=""><figcaption><p>Model Selector node</p></figcaption></figure>
...
[Learn more about source control environments](/administer/use-source-control-and-environments.md)
...
Learn more about implementing RAG in n8n [here](/build/integrate-ai/understand-ai-components/retrieve-relevant-context.md).<br>

<figure><img src="/files/K7Y0WB7BDvjQTsEJqbr5" alt=""><figcaption><p>RAG starter template</p></figcaption></figure>
...
Learn more about [sub-workflows](/build/flow-logic/break-workflows-into-smaller-parts.md).
...
\ <img src="/files/4VKDJ2MJgbKLM5NhFuhe" alt="Evaluation node" data-size="original"><br>
...
3. To evaluate output quality, add a third **Evaluation** node with the **Set Metrics** operation at a point after you’ve generated the outputs. You can develop workflow logic, custom calculations, or add an LLM-as-Judge to score the outputs. Map these metrics to your dataset in the node’s parameters.<br>
   ...
   > 💡 Well-defined metrics = smarter decisions. Scoring your outputs based on similarity, correctness, or categorization can help you track whether changes are actually improving performance. Learn more and get links to example templates [here](/build/integrate-ai/test-and-improve-ai-workflows/use-metrics-to-measure-quality.md#2-add-metrics-to-workflow).

\ <img src="/files/uXIFrescEYPHrncQMDGf" alt="Evaluation workflow" data-size="original"><br>
...
You can find details, tips, and common troubleshooting info [here](/build/integrate-ai/test-and-improve-ai-workflows/fix-common-issues.md).\ <br>
...
Make sure you're on **n8n version 1.94.0** or later and the instance Owner has enabled verified community nodes. On Cloud, this can be done from the Admin Panel. For self-hosted instances, please refer to [documentation](/deploy/host-n8n/configure-n8n/basic-configuration/use-environment-variables/nodes.md). In both cases, verified nodes are enabled by default.
...
1. Review the [community node verification guidelines](/connect/create-nodes/build-your-node/reference/verification-guidelines.md).
2. If you’re building something new, follow the recommendations for [creating nodes](/connect/create-nodes/overview.md).
3. Check your design against the [UX guidelines](/connect/create-nodes/build-your-node/reference/ux-guidelines.md).
4. [Submit your node](/connect/create-nodes/deploy-your-node/submit-community-nodes.md) to npm.
...
Two weeks after the launch of [Insights](/administer/observe-and-log/track-usage-with-insights.md), we’re releasing some enhancements designed for enterprise users.
...
<figure><img src="/files/1fnGhDNGM8lWlqmh73bn" alt=""><figcaption><p>Filter insights</p></figcaption></figure>
...
👉 Learn more about configuring the [HTTP Request tool](/integrations/builtin/core-nodes/n8n-nodes-base.httprequest.md).
...
<figure><img src="/files/pXp7hcNZGaZDZ1tx3Ii5" alt=""><figcaption><p>Scoped API keys</p></figcaption></figure>
...
📁 Folders are available to all [registered](/deploy/host-n8n/community-edition-features.md#registered-community-edition) users—jump in and get your workspace in order!
...
<img src="/files/INsx9yfFFmkuXRXdvfch" alt="Insights summary banner" data-size="original">
...
<img src="/files/mnQttUoMt3pGaBtTv9u5" alt="Insights dashboard" data-size="original">
...
[![Studio](/files/4FU5519xBx1GrT2o53gn)](https://youtu.be/45WPU7P-1QQ?feature=shared)
...
<img src="/files/piAHhz6qYkTmRfiRdjM5" alt="MCP Server Trigger" data-size="original">
...
<img src="/files/YP5hRzULIura0FoXmzcU" alt="MCP Client Tools" data-size="original">
...
Folders are available for all [registered](/deploy/host-n8n/community-edition-features.md#registered-community-edition) users so get started with decluttering your workspace now and look for more features (like drag and drop) to organize your instances soon.
...
<figure><img src="/files/wTX6EzIj30yu7JKk6JKP" alt=""><figcaption><p>Form with custom CSS applied</p></figcaption></figure>
...
<figure><img src="/files/VFQWbRu38zYXNKvuQJlf" alt=""><figcaption><p>Multiple API keys</p></figcaption></figure>
...
<figure><img src="/files/kypna115CHAw5696mG3b" alt=""><figcaption><p>Commit modal</p></figcaption></figure>

<br>

<figure><img src="/files/JpgLXbRoAzvZuv21zwFK" alt=""><figcaption><p>Pull notification</p></figcaption></figure>
...
[![Studio](/files/paRsb9amxse4dNLLtV4J)](https://youtu.be/De1E58MPaMQ?t=645)
{% endhint %}
...
* [AI Agent](/integrations/builtin/cluster-nodes/root-nodes/n8n-nodes-langchain.agent.md): Vector stores can now be directly used as tools for the agent
* [Code](/build/code-in-n8n/use-built-in-shortcuts.md): Tons of new speed and convenience features, see above for details
...
We also added a custom [projects](/administer/manage-users-and-access/set-permissions-and-roles-rbac/organize-work-in-projects.md) icon selector on top of the available emojis. Pretty!
...
* [AI Agent](/integrations/builtin/cluster-nodes/root-nodes/n8n-nodes-langchain.agent.md): Updated descriptions for Chat Trigger options
* [Facebook Graph API](/integrations/builtin/app-nodes/n8n-nodes-base.facebookgraphapi.md): Updated for API v21.0
* [Gmail](/integrations/builtin/app-nodes/n8n-nodes-base.gmail.md): Added two new options for the `Send and wait` operation, free text and custom form
...
We added filters and text search to the commit modal when working with [Environments](/administer/use-source-control-and-environments.md). This will make committing easier as we provide more information and better visibility. Environments are available on the Enterprise plan.
...
<img src="/files/P4au1lJFjj9Yilj2ZbcA" alt="Task runners overview" data-size="original">
...
Currently, this feature is opt-in and can be enabled using [environment variables](/deploy/host-n8n/configure-n8n/basic-configuration/use-environment-variables/task-runners.md). Once stable, it will become the default execution method for Code nodes.

To start using Task runners today, [check out the docs](/deploy/host-n8n/configure-n8n/set-up-task-runners.md).
{% endhint %}
...
* [Code node](/integrations/builtin/core-nodes/n8n-nodes-base.code.md): We added a warning if `pairedItem` is absent or could not be auto mapped
...
* [Gmail Trigger](/integrations/builtin/trigger-nodes/n8n-nodes-base.gmailtrigger.md): Added option to filter for draft messages
...
<img src="/files/7Eq9yxhvD559HlYeqX8g" alt="A multi-page form with branching" data-size="original">
...
* [AI Agent](/integrations/builtin/cluster-nodes/root-nodes/n8n-nodes-langchain.agent.md): Removed the requirement to add at least one tool
* [GitHub](/integrations/builtin/app-nodes/n8n-nodes-base.github.md): Added workflows as a resource operation
* [Structured Output Parser](/integrations/builtin/cluster-nodes/sub-nodes/n8n-nodes-langchain.outputparserstructured.md): Added more user-friendly error messages
...
The [Remove Duplicates node](/integrations/builtin/core-nodes/n8n-nodes-base.removeduplicates.md) got a major makeover with the addition of two new operations:
...
* [OpenAI](/integrations/builtin/app-nodes/n8n-nodes-langchain.openai.md): Added the option to choose between the default memory connector to provide memory to the assistant or to specify a thread ID
* [Gmail](/integrations/builtin/app-nodes/n8n-nodes-base.gmail.md) and [Slack](/integrations/builtin/app-nodes/n8n-nodes-base.slack.md): Added custom approval operations to have a human in the loop of a workflow

We have also optimized the [worker health checks](/deploy/host-n8n/keep-n8n-running/monitor-n8n.md) (see breaking change above).
...
We have made additional nodes usable with the [Tools AI Agent node](/integrations/builtin/cluster-nodes/root-nodes/n8n-nodes-langchain.agent/tools-agent.md).\ <br>
...
* [HTTP Request](/integrations/builtin/core-nodes/n8n-nodes-base.httprequest.md): Added credential support for Sysdig
* [Invoice Ninja](/integrations/builtin/app-nodes/n8n-nodes-base.invoiceninja.md): Additional query params for getAll requests
* [Question and Answer Chain](/integrations/builtin/cluster-nodes/root-nodes/n8n-nodes-langchain.chainretrievalqa.md): Added the option to use a custom prompt

Drag and drop insertion on cursor position from schema view is now also enabled for code, SQL and Html fields in nodes.

Customers with an enterprise license can now rate, tag and highlight execution data in the executions view. To use highlighting, add an [Execution Data Node](/integrations/builtin/core-nodes/n8n-nodes-base.executiondata.md) (or Code node) to the workflow to set [custom executions data](/build/understand-workflows/understand-executions/customize-executions-data.md).
...
You can now [expose and consume metrics from your workers](/deploy/host-n8n/configure-n8n/basic-configuration/configuration-examples/enable-prometheus-metrics.md). The worker instances have the same metrics available as the main instance(s) and can be configured with [environment variables](/deploy/host-n8n/configure-n8n/basic-configuration/use-environment-variables/endpoints.md).
{% endhint %}

You can now customize the maximum file size when uploading files within forms to webhooks. The [environment variable to set](/deploy/host-n8n/configure-n8n/basic-configuration/use-environment-variables/endpoints.md) for this is `N8N_FORMDATA_FILE_SIZE_MAX`. The default setting is 200MiB.
...
* [OpenAI](/integrations/builtin/app-nodes/n8n-nodes-langchain.openai.md): Added O1 models to the model select
...
<img src="/files/a3FGWYhlXtsgpeTpE0ER" alt="Collaboration avatars" data-size="original">
{% endhint %}
...
We are [exposing new execution queue metrics](/deploy/host-n8n/configure-n8n/basic-configuration/configuration-examples/enable-prometheus-metrics.md) to give users more visibility of the queue length. This helps to inform decisions on horizontal scaling, based on queue status. We have also made querying executions faster.
{% endhint %}
...
Our [public REST API](/connect/n8n-api.md) now supports additional operations:

* Create, delete, and edit roles for users
* Create, read, update and delete projects

Find the details in the [API reference](/connect/n8n-api/api-reference.md).
...
This release adds [Google Cloud Platform Secrets Manager](/administer/manage-credentials/use-external-secret-stores.md) to the list of external secret stores. We already support AWS secrets, Azure Key Vault, Infisical and HashiCorp Vault. External secret stores are available under an enterprise license.
{% endhint %}
...
This release adds [Azure Key Vault](/administer/manage-credentials/use-external-secret-stores.md) to the list of external secret stores. We already support AWS secrets, Infisical and HashiCorp Vault and are working on Google Secrets Manager. External secret stores are available under an enterprise license.
{% endhint %}
...
This release adds the HTTP request tool. You can use it with an AI agent as a tool to collect information from a website or API. Refer to the [HTTP request tool](/integrations/builtin/core-nodes/n8n-nodes-base.httprequest.md) for details.
{% endhint %}
...
\
Refer to the [RBAC](/administer/manage-users-and-access/set-permissions-and-roles-rbac.md) documentation for information on creating projects and using roles.\
\
...
* Improved [memory support for OpenAI assistants](/integrations/builtin/app-nodes/n8n-nodes-langchain.openai.md).
...
Self-hosted users need to [enable AI features and provide their own API keys](/deploy/host-n8n/configure-n8n/basic-configuration/use-environment-variables.md)
{% endhint %}
...
Please note that this version contains a breaking change for self-hosted n8n. It removes the `--file` flag for the `execute` CLI command. If you have scripts relying on the `--file` flag, update them to first import the workflow and then execute it using the `--id` flag. Refer to [CLI commands](/deploy/host-n8n/configure-n8n/use-the-command-line.md) for more information on CLI options.
{% endhint %}
...
This release includes a new version of the [OpenAI node](/integrations/builtin/app-nodes/n8n-nodes-langchain.openai.md), adding more operations, including support for working with assistants.
{% endhint %}

Other highlights:

* Support for AI events in [log streaming](/administer/observe-and-log/stream-logs-to-external-systems.md).
* Added support for workflow tags in the [public API](/connect/n8n-api.md).
...
This release removes `own` mode for self-hosted n8n. You must now use `EXECUTIONS_MODE` and set to either `regular` or `queue`. Refer to [Queue mode](/deploy/host-n8n/configure-n8n/scaling/enable-queue-mode.md) for information on configuring queue mode.
{% endhint %}
...
n8n has created a new [Chat Trigger node](/integrations/builtin/core-nodes/n8n-nodes-langchain.chattrigger.md). The new node provides a chat interface that you can make publicly available, with customization and authentication options.
{% endhint %}
...
* [Remove Duplicates](/integrations/builtin/core-nodes/n8n-nodes-base.removeduplicates.md): identify and delete items that are identical across all fields or a subset of fields.
...
This release adds LangChain support to the main n8n version. Refer to [LangChain](/build/integrate-ai.md) for more information on how to build AI tools in n8n, the new nodes n8n has introduced, and related learning resources.
{% endhint %}
...
Cloud Pro and Enterprise users can now search and filter the input and output data in nodes. Refer to [Data filtering](/build/work-with-data/filter-out-unwanted-data.md) for more information.
{% endhint %}
...
Learn more in the [Workflow history](/build/manage-workflows/view-change-history.md) documentation.
{% endhint %}
...
The HTTP Request node now supports an pagination. Read the [node docs](/integrations/builtin/core-nodes/n8n-nodes-base.httprequest.md) for information and examples.
{% endhint %}
...
Self-hosted users can now use an external service to store binary data. Learn more in [External storage](/deploy/host-n8n/configure-n8n/scaling/use-external-storage.md).
...
* This is a beta release, and not yet available in the main product. Follow the instructions in [Access LangChain in n8n](/build/integrate-ai.md) to try it out. Self-hosted and Cloud options are available.
* Learn how LangChain concepts map to n8n nodes in [LangChain concepts in n8n](/build/integrate-ai.md).
* Browse n8n's new [Cluster nodes](/integrations/builtin/cluster-nodes.md). This is a new set of node types that allows for multiple nodes to work together to configure each other.
...
Refer to [External secrets](/administer/manage-credentials/use-external-secret-stores.md) for guidance on enabling and using this feature.
{% endhint %}
...
n8n now supports two-factor authentication (2FA) for self-hosted instances. n8n is working on bringing support to Cloud. Refer to [Two-factor authentication](/administer/manage-users-and-access/verify-user-identity/require-two-factor-auth.md) for guidance on enabling and using it.
{% endhint %}
...
Refer to [Debug executions](/build/understand-workflows/understand-executions/debug-executions.md) for guidance on using this feature.
{% endhint %}
...
Learn how to use the feature, including guidance on writing prompts, in [Generate code with ChatGPT](/build/code-in-n8n/get-coding-help-from-ai.md).
{% endhint %}
...
This makes it easier to do [Custom operations](/integrations/builtin/custom-api-actions-for-existing-nodes.md) with these services, using the [HTTP Request](/integrations/builtin/core-nodes/n8n-nodes-base.httprequest.md) node.
{% endhint %}
...
Please note that this version contains breaking changes if upgrading from a `0.x.x` version. For full details, refer to the [n8n v1.0 migration guide](/changelog/v10-migration-guide.md).
{% endhint %}
...
Refer to [Source control and environments](/administer/use-source-control-and-environments.md) to learn more about the features and set up your environments.
{% endhint %}
...
Please note that this version contains breaking changes. For full details, refer to the [n8n v1.0 migration guide](/changelog/v10-migration-guide.md).
{% endhint %}

This is n8n's version one release.

For full details, refer to the [n8n v1.0 migration guide](/changelog/v10-migration-guide.md).
