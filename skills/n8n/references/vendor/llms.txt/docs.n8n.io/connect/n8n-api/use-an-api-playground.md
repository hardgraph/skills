> For the complete documentation index, see [llms.txt](https://docs.n8n.io/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.n8n.io/connect/n8n-api/use-an-api-playground.md).
...
You can test API calls from this site's [endpoint reference](/connect/n8n-api/api-reference.md). You need to set your server's base URL and instance name, and add an API key.
