> For the complete documentation index, see [llms.txt](https://docs.n8n.io/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.n8n.io/build/manage-workflows/n8n-packages/how-import-works.md).
...
This page covers what n8n does with an [n8n package](/build/manage-workflows/n8n-packages.md) once you've called [import](/build/manage-workflows/n8n-packages/import-a-package.md): how it decides whether the import can go ahead, and how it resolves each kind of entity.
...
1. An explicit [binding](/build/manage-workflows/n8n-packages/import-a-package.md#bindings), if you gave one for that credential.
...
* [Import a package](/build/manage-workflows/n8n-packages/import-a-package.md) for the options this page refers to.
* [Limits and permissions](/build/manage-workflows/n8n-packages/limits-and-permissions.md) for the license features, scopes, and quotas an import checks.
* [Package format](/build/manage-workflows/n8n-packages/package-format.md) for what's in the files n8n is reading.
