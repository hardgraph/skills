...
# Try free then choose a plan

[n8n Cloud](/deploy/use-n8n-cloud.md) is the managed way to run n8n: n8n hosts your instance, so you don't set up or maintain any infrastructure. The best way to start is with a free trial, then move to a paid plan that fits your needs.
