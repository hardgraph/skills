...
url: https://docs.apify.com/academy/api-scraping/general-api-scraping/cookies-headers-tokens.md
parents:
  - [Apify documentation](https://docs.apify.com/llms.txt)
  - [Apify Academy](https://docs.apify.com/academy.md)
  - [API scraping](https://docs.apify.com/academy/api-scraping.md)
  - [General API scraping](https://docs.apify.com/academy/api-scraping/general-api-scraping.md)
previous: [Locating API endpoints](https://docs.apify.com/academy/api-scraping/general-api-scraping/locating-and-learning.md)
next: [Handling pagination](https://docs.apify.com/academy/api-scraping/general-api-scraping/handling-pagination.md)
---
