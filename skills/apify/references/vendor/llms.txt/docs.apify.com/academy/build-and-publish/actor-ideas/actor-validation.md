...
url: https://docs.apify.com/academy/build-and-publish/actor-ideas/actor-validation.md
parents:
  - [Apify documentation](https://docs.apify.com/llms.txt)
  - [Apify Academy](https://docs.apify.com/academy.md)
previous: [Find ideas for new Actors](https://docs.apify.com/academy/build-and-publish/actor-ideas/find-actor-ideas.md)
next: [How to build an Actor](https://docs.apify.com/academy/actor-marketing-playbook/store-basics/how-to-build-actors.md)
---
