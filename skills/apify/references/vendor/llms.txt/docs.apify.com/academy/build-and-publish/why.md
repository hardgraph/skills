...
url: https://docs.apify.com/academy/build-and-publish/why.md
parents:
  - [Apify documentation](https://docs.apify.com/llms.txt)
  - [Apify Academy](https://docs.apify.com/academy.md)
previous: [VII - Saving run stats](https://docs.apify.com/academy/expert-scraping-with-apify/solutions/saving-stats.md)
next: [Find ideas for new Actors](https://docs.apify.com/academy/build-and-publish/actor-ideas/find-actor-ideas.md)
---
