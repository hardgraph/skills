...
- [heat-graph](/docs/utilities/heat-graph) — Activity heatmap primitives in the same Radix-style headless pattern.
- [Primitives overview](/docs/primitives) — The broader assistant-ui primitive system.