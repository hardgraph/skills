---
title: Source code
url: https://docs.apify.com/actors/development/actor-definition/source-code.md
parents:
...
previous: [actor.json](https://docs.apify.com/actors/development/actor-definition/actor-json.md)
next: [Actor input schema](https://docs.apify.com/actors/development/actor-definition/input-schema.md)
---
...
The Apify Actor's source code placement is defined by its [Dockerfile](https://docs.apify.com/actors/development/actor-definition/dockerfile.md). If you have created the Actor from one of Apify's [templates](https://apify.com/templates) then it's by convention placed in the `/src` directory.
