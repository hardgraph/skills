...
url: https://docs.apify.com/integrations/make/e-commerce.md
parents:
  ...
  - [Make](https://docs.apify.com/integrations/make.md)
previous: [AI Crawling](https://docs.apify.com/integrations/make/ai-crawling.md)
next: [LLMs](https://docs.apify.com/integrations/make/llm.md)
---
...
# Make - E-commerce Scraping Tool integration
...
![Apify sign-up page](/assets/images/apify-sign-up-page-105ecb8bed624044c685097d4bdf2414.webp)
...
1. In Make, add the **Extract using E-commerce Scraping Tool** module and click **Add** to open the **Create a connection** dialog. Open the **Connection type** dropdown, select the OAuth option, name the connection, and click **Save**.
   ...
   ![Create a connection dialog in Make](/assets/images/apify-OAuth-for-module-e-commerce-700ec31f8bb685709c88f386df9771be.webp)

2. A sign-in popup opens. Choose the Apify account to connect, either a personal or an organization account.

   ![Choose an Apify account](/assets/images/apify-OAuth-popup-78e15c9cbc45bde72be91825612b89ef.webp)

3. Review the permissions Make requests, your profile data and full API access, then click **Allow access**. The popup closes and the connection is ready to use.

   ![Apify permission request for Make](/assets/images/apify-OAuth-permission-popup-db76796ffc1dde8f00374c9a0c07709a.webp)
...
1. In Apify Console, open the **Settings > API & Integrations** tab at [console.apify.com/settings/integrations](https://console.apify.com/settings/integrations).
   ...
   ![Apify Console token for Make](/assets/images/apify-console-token-for-make-cf75dbeb5effdcab9bc204cee94cdb6a.png)

2. Find your token under **Personal API tokens**, or create a new token with customizable permissions by clicking **+ Create a new token**. Copy the token and go back to Make.

   ![Apify token on Make](/assets/images/Apify_token_on_Make-78f67b559503d92cffb17e5abffd18d2.png)

3. In Make, click **Add** to open the **Create a connection** dialog, select the **Apify API Token** connection type, paste the token into the **API token** field, name your connection, and click **Save**.

   ![Make API token field](/assets/images/apify-token-for-module-e-commerce-c39b5a384c9427ab3b42f45a8a7a8088.webp)
...
2. It polls the run until it finishes (this can take from seconds to several minutes depending on how much data you request).
3. It reads the run's dataset and outputs each item as a bundle.
...
Product Details bundle (shortened)
...
Search Engine bundle (shortened)
...
Food Delivery bundle (shortened)
...
Influencer Storefronts bundle (shortened)
...
![Example input configuration for the Extract using E-commerce Scraping Tool module](/assets/images/apify-example-input-fc63cf6de0274be85c2f7a0650c5fddc.webp)
...
![Successful run showing the extracted product bundles returned by the module](/assets/images/apify-result-e-commerce-000fa2347c5dad1357e09d2ed22a4d2c.webp)
