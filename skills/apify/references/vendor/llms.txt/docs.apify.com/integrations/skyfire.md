...
url: https://docs.apify.com/integrations/skyfire.md
parents:
  - [Apify documentation](https://docs.apify.com/llms.txt)
  - [Integrations](https://docs.apify.com/integrations.md)
  - [AI](https://docs.apify.com/integrations/ai.md)
previous: [Qdrant](https://docs.apify.com/integrations/qdrant.md)
next: [Strands Agents SDK](https://docs.apify.com/integrations/strands-agents.md)
---
...
1. *A Skyfire account* with a funded wallet - [sign up at Skyfire](https://app.skyfire.xyz/auth)
...
Replace `actor1,actor2,actor3` with the actual Actor IDs you want to make available, such as `junglee/free-amazon-product-scraper,streamers/youtube-scraper`. See which Actors support agentic payments.
