...
url: https://docs.apify.com/integrations/github.md
parents:
  - [Apify documentation](https://docs.apify.com/llms.txt)
  - [Integrations](https://docs.apify.com/integrations.md)
  - [Programming](https://docs.apify.com/integrations/programming.md)
previous: [API integration](https://docs.apify.com/integrations/api.md)
next: [Webhook integration](https://docs.apify.com/integrations/webhooks.md)
---
...
![Let\&#39;s build a new Actor page in Apify Console](/assets/images/apify-git-repository-3af13f8088bec61ab6c4e68416727ed9.png)
...
![Authorize Apify on GitHub](/assets/images/apify-git-repository-add-cea31f962e8e7937f5e4cc246e41ea82.png)

To switch between authorized users and organizations, use the account dropdown.

![Account picker](/assets/images/apify-git-repository-account-63de9314b2ac9363d85ab8c6c4b0a2bc.png)
...
![Repository search](/assets/images/apify-git-repository-search-007955d7c791366f32c2d745266eb776.png)
...
For private repositories, configure a [deployment key](https://docs.apify.com/actors/development/deployment/source-types.md#private-repositories) so Apify can clone the code.
...
For automated tests and multi-branch workflows (for example, separate `latest` and `beta` tags), follow the [Continuous integration for Actors](https://docs.apify.com/actors/development/deployment/continuous-integration.md) guide.
...
1. In Apify Console, open the Actor and go to the **Integrations** tab.
   ...
   ![Add integration page on an Actor\&#39;s Integrations tab](/assets/images/integrations-tab-407d3c50c55b932a1a4f3e055dcf2b5f.png)
...
For the full list of variables you can use, see [Webhook actions](https://docs.apify.com/integrations/webhooks/actions.md#available-variables).
...
3. Trigger a real failure (for example, run the Actor with input that you know will cause a failure) and confirm an issue is created.
...
* [Source types for Actors](https://docs.apify.com/actors/development/deployment/source-types.md) - Configure the Git URL, branch, and monorepo paths.
* [Continuous integration for Actors](https://docs.apify.com/actors/development/deployment/continuous-integration.md) - Run tests and trigger builds with GitHub Actions.
* [Webhook events](https://docs.apify.com/integrations/webhooks/events.md) and [actions](https://docs.apify.com/integrations/webhooks/actions.md) - Reference for available events and the payload template.
