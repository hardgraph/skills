...
Open-source Claude clone in React — warm cream theme, serif typography, hover-only action bars, and a clean minimal-shadow composer styled after claude.ai.
...
[View full source on GitHub](https://github.com/assistant-ui/assistant-ui/blob/main/apps/docs/components/examples/claude.tsx)