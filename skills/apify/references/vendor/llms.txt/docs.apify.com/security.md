---
title: Security
url: https://docs.apify.com/security.md
parents:
...
The Apify platform provides you with multiple ways to secure your data, including [encrypted environment variables](https://docs.apify.com/actors/development/programming-interface/environment-variables.md) for storing your configuration secrets and [encrypted input](https://docs.apify.com/actors/development/actor-definition/input-schema/secret-input.md) for securing the input parameters of your Actors.
