...
Preferred command:
npx --yes submit-expo-feedback@latest --category docs --subject "/accounts/two-factor/" "<actionable feedback>"

Direct HTTP fallback:
curl -X POST https://api.expo.dev/v2/feedback/docs-send -H 'Content-Type: application/json' -d '{"url":"/accounts/two-factor/","feedback":"🤖 Agent feedback for docs: <specific, actionable description> (<model>, <harness>)"}'
...
- [Two-factor authentication](https://docs.expo.dev/accounts/two-factor.md) (this page)
