> For the complete documentation index, see [llms.txt](https://docs.n8n.io/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.n8n.io/choose-how-to-use-n8n.md).
...
<figure><picture><source srcset="/files/d4qnqcLm6Fc3igPAFJR7" media="(prefers-color-scheme: dark)"><img src="/files/zsZQ0zzJyptPmDV5uR3j" alt="Decision flowchart: n8n Cloud offers the Starter, Pro, and Enterprise plans; self-hosted offers the Community, registered Community, Business, and Enterprise editions"></picture><figcaption><p>Choosing your n8n deployment option, plan, and edition</p></figcaption></figure>
...
For how to start a trial and upgrade, see [Try free then choose a plan](/deploy/use-n8n-cloud/start-your-free-trial.md). For what each plan includes, see the [pricing page](https://n8n.io/pricing/).
...
For the differences between editions and how to register or license an instance, see [Compare plans and editions](/deploy/host-n8n/community-edition-features.md). For what each plan includes, see the [pricing page](https://n8n.io/pricing/).
...
Feature availability changes over time and differs by plan and edition. For exactly what each plan and edition includes, the [pricing page](https://n8n.io/pricing/) is the definitive source. See also [Compare plans and editions](/deploy/host-n8n/community-edition-features.md) for how the self-hosted plans and editions differ.

## Getting started <a href="#getting-started" id="getting-started"></a>

Ready to begin?

* [**Get started with n8n Cloud**](https://n8n.io/cloud/) — sign up for instant access, then [choose a plan](/deploy/use-n8n-cloud/start-your-free-trial.md)
* [**Get started with self-hosted**](/deploy/host-n8n.md) — installation and deployment guides, then [choose a plan or edition](/deploy/host-n8n/community-edition-features.md)
