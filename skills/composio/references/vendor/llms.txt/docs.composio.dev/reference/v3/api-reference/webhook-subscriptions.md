...
> **API version:** This page documents Composio REST API v3.0 at `https://backend.composio.dev/api/v3`, the previous version. v3.1 is current, at `https://backend.composio.dev/api/v3.1` — the same page on v3.1 is /reference/api-reference/webhook-subscriptions.md.
...
| --- | --- | --- |
| `POST` | `/api/v3/webhook_subscriptions` | [Create webhook subscription](/reference/v3/api-reference/webhook-subscriptions/postWebhookSubscriptions) |
| `GET` | `/api/v3/webhook_subscriptions` | [List webhook subscriptions](/reference/v3/api-reference/webhook-subscriptions/getWebhookSubscriptions) |
| `GET` | `/api/v3/webhook_subscriptions/{id}` | [Get webhook subscription](/reference/v3/api-reference/webhook-subscriptions/getWebhookSubscriptionsById) |
| `PATCH` | `/api/v3/webhook_subscriptions/{id}` | [Update webhook subscription](/reference/v3/api-reference/webhook-subscriptions/patchWebhookSubscriptionsById) |
| `DELETE` | `/api/v3/webhook_subscriptions/{id}` | [Delete webhook subscription](/reference/v3/api-reference/webhook-subscriptions/deleteWebhookSubscriptionsById) |
| `POST` | `/api/v3/webhook_subscriptions/{id}/rotate_secret` | [Rotate webhook secret](/reference/v3/api-reference/webhook-subscriptions/postWebhookSubscriptionsByIdRotateSecret) |
| `GET` | `/api/v3/webhook_subscriptions/event_types` | [List available event types](/reference/v3/api-reference/webhook-subscriptions/getWebhookSubscriptionsEventTypes) |
