...
url: https://docs.apify.com/academy/scraping-basics-javascript/devtools-locating-elements.md
parents:
...
previous: [DevTools: Inspecting](https://docs.apify.com/academy/scraping-basics-javascript/devtools-inspecting.md)
next: [DevTools: Extracting data](https://docs.apify.com/academy/scraping-basics-javascript/devtools-extracting-data.md)
---
