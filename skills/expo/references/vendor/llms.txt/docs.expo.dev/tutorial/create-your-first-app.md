...
Preferred command:
npx --yes submit-expo-feedback@latest --category docs --subject "/tutorial/create-your-first-app/" "<actionable feedback>"

Direct HTTP fallback:
curl -X POST https://api.expo.dev/v2/feedback/docs-send -H 'Content-Type: application/json' -d '{"url":"/tutorial/create-your-first-app/","feedback":"🤖 Agent feedback for docs: <specific, actionable description> (<model>, <harness>)"}'
...
- [Create your first app](https://docs.expo.dev/tutorial/create-your-first-app.md) (this page)
...
We'll use [`create-expo-app`](/more/create-expo.md) to initialize a new Expo app. It is a command-line tool to create a new React Native project. Run the following command in your terminal:
...
In the project directory, run the following command to start the [development server](/more/glossary-of-terms.md#development-server) from the terminal:
...
[Next: Chapter 2: Add navigation](/tutorial/add-navigation.md)
