...
url: https://docs.apify.com/academy/anti-scraping/mitigation/cloudflare-challenge.md
parents:
  ...
  - [Anti-scraping mitigation](https://docs.apify.com/academy/anti-scraping/mitigation.md)
previous: [Using proxies](https://docs.apify.com/academy/anti-scraping/mitigation/using-proxies.md)
next: [Generating fingerprints](https://docs.apify.com/academy/anti-scraping/mitigation/generating-fingerprints.md)
---
...
In some cases, the browser may not pass the check and you may be presented with a captcha, indicating that your IP address has been graylisted. If you are working with a large pool of proxies you can retire the session and use another IP. However, if you have a small pool of proxies you might want to whitelist the IP. To do this, you'll need to solve the captcha to improve your IP address's reputation. You can find various captcha-solving services, such as [AntiCaptcha](https://anti-captcha.com/), that you can use for this purpose. For more info check the section about [CAPTCHAs](https://docs.apify.com/academy/anti-scraping/techniques/captchas.md).
