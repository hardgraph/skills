# LangGraph Stockbroker Demo
URL: /examples/stockbroker

Human-in-the-loop AI stockbroker built on LangGraph and assistant-ui — interrupt handling, tool approval, and an interactive React chat UI.

> For AI agents: a documentation index is available at [llms.txt](/llms.txt). Use `.md` for canonical markdown pages; `.mdx` is kept as a backwards-compatible alias on supported URL paths.

[Stockbroker example](https://assistant-ui-stockbroker.vercel.app/)
...
[View full source on GitHub](https://github.com/assistant-ui/assistant-ui-stockbroker)