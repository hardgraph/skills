...
url: https://docs.apify.com/academy/puppeteer-playwright/reading-intercepting-requests.md
parents:
...
previous: [Extracting data](https://docs.apify.com/academy/puppeteer-playwright/executing-scripts/collecting-data.md)
next: [V - Using proxies](https://docs.apify.com/academy/puppeteer-playwright/proxies.md)
---
