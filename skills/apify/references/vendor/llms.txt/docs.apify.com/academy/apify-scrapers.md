...
url: https://docs.apify.com/academy/apify-scrapers.md
parents:
  - [Apify documentation](https://docs.apify.com/llms.txt)
  - [Apify Academy](https://docs.apify.com/academy.md)
children:
  - [Getting started with Apify scrapers](https://docs.apify.com/academy/apify-scrapers/getting-started.md)
  - [Scraping with Web Scraper](https://docs.apify.com/academy/apify-scrapers/web-scraper.md)
  - [Scraping with Cheerio Scraper](https://docs.apify.com/academy/apify-scrapers/cheerio-scraper.md)
  - [Scraping with Puppeteer Scraper](https://docs.apify.com/academy/apify-scrapers/puppeteer-scraper.md)
previous: [How to process data in Python using Pandas](https://docs.apify.com/academy/python/process-data-using-python.md)
next: [Getting started with Apify scrapers](https://docs.apify.com/academy/apify-scrapers/getting-started.md)
---
