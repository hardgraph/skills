...
- [Learn how to use Data Feeds](/data-feeds/getting-started): If you are already familiar with smart contracts and want to learn how to create *hybrid* smart contracts, use Chainlink Data Feeds to get asset price data onchain.
...
Oracles are most popularly used with [*Data Feeds*](/data-feeds). DeFi platforms like [AAVE](https://aave.com/) and [Synthetix](https://www.synthetix.io/) use Chainlink data feed oracles to obtain accurate real-time asset prices in their smart contracts.
