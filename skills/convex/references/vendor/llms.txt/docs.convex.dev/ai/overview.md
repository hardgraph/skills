...
## Agent plugins[​](#plugins "Direct link to Agent plugins")

Convex publishes official plugins for coding agents that include:
...
* [Claude Code](/ai/using-claude-code.md#install-the-convex-plugin-in-claude-code)
* [Codex](/ai/using-codex.md#install-the-convex-plugin)
* [Cursor](/ai/using-cursor.md#install-the-convex-plugin-in-cursor)
...
* [GitHub Copilot](/ai/using-github-copilot.md)
* [![](/assets/images/conductor-logo-00000000.png)](/ai/using-conductor.md)

  [Conductor](/ai/using-conductor.md)

When using  Claude Code or  Cursor, we recommend installing the [Convex plugin](/ai/overview.md#plugins), which automatically include these rules.
