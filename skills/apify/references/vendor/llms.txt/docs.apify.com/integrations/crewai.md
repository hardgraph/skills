...
url: https://docs.apify.com/integrations/crewai.md
parents:
  - [Apify documentation](https://docs.apify.com/llms.txt)
  - [Integrations](https://docs.apify.com/integrations.md)
  - [AI](https://docs.apify.com/integrations/ai.md)
previous: [Claude Desktop](https://docs.apify.com/integrations/claude-desktop.md)
next: [Cursor](https://docs.apify.com/integrations/cursor.md)
---
