...
url: https://docs.apify.com/proxy/datacenter-proxy.md
parents:
  - [Apify documentation](https://docs.apify.com/llms.txt)
  - [Proxy](https://docs.apify.com/proxy.md)
previous: [Overview](https://docs.apify.com/proxy.md)
next: [Residential proxy](https://docs.apify.com/proxy/residential-proxy.md)
---
...
If you want to pick an IP address and pass all subsequent connections via that same IP address, you can use the `session` [parameter](https://docs.apify.com/proxy.md#sessions).

### Username parameters

The `username` field enables you to pass various [parameters](https://docs.apify.com/proxy.md#connection-settings), such as groups, session and country, for your proxy connection.
...
When you use datacenter proxy with the `session` [parameter](https://docs.apify.com/proxy.md#sessions) set in the `username` field, a single IP is assigned to the `session ID` provided after you make the first request.
