...
url: https://docs.apify.com/integrations/activepieces.md
parents:
...
previous: [Albato](https://docs.apify.com/integrations/albato.md)
next: [Bubble](https://docs.apify.com/integrations/bubble.md)
---
...
* Optional *steps* that transform or query data
* One or more *actions* that execute when the flow runs
...
* An Apify [API key](https://docs.apify.com/integrations/api.md#api-token) with access to the Actors, tasks, and storages you want to use
...
3. Search for and select the Apify piece.
4. Enter your **API Key** from Apify:
   <!-- -->
   * You can find it in Apify Console under **Settings → API & Integrations**.
5. Save the connection.

![Apify API key setup](/assets/images/api-token-c7f0f14a513f03e5b3d67f37cfa240c0.png)
...
![Select Apify trigger](/assets/images/select-trigger-1282aa4a3470301ae4efb3ff02e03960.png)
...
![Configure Apify trigger](/assets/images/trigger-example-b357646eb241325dcc08910976ca75f6.png)
...
4. Select your Apify connection.

5. Configure the action parameters.

![Select Apify action](/assets/images/select-action-bc3ae69a999b99d59ba997e9a7660aa2.png)
...
![Configure Apify Run Actor action](/assets/images/run-actor-example-467213e107598e9840af8dcb47837dbd.png)
...
* **Get Dataset Items** retrieves items from an Apify [dataset](https://docs.apify.com/storage/dataset.md):
...
* **Get Key-Value Store Record** retrieves a value from an Apify [key-value store](https://docs.apify.com/storage/key-value-store.md):
