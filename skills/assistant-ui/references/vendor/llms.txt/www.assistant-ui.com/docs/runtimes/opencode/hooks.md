...
- [OpenCode overview](/docs/runtimes/opencode/overview) — What OpenCode is and when to pick it.
- [Quickstart](/docs/runtimes/opencode/quickstart) — Minimal runtime + Thread setup.
- [OpenCode docs](https://opencode.ai/) — The OpenCode server itself.