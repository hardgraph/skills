...
{% hint style="info" %}
Ask n8n AI is n8n's built-in help assistant and is no longer actively developed. To build, edit, and run workflows from a chat, see [Use AI Assistant](/build/ways-of-building-workflows/ai-assistant.md).
{% endhint %}
