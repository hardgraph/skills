...
url: https://docs.apify.com/academy/advanced-web-scraping/crawling/sitemaps-vs-search.md
parents:
...
previous: [Tips and tricks for robustness](https://docs.apify.com/academy/advanced-web-scraping/tips-and-tricks-robustness.md)
next: [Crawling sitemaps](https://docs.apify.com/academy/advanced-web-scraping/crawling/crawling-sitemaps.md)
---
