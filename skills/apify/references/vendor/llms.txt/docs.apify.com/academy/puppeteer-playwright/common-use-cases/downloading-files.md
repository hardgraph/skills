...
url: https://docs.apify.com/academy/puppeteer-playwright/common-use-cases/downloading-files.md
parents:
...
previous: [Paginating through results](https://docs.apify.com/academy/puppeteer-playwright/common-use-cases/paginating-through-results.md)
next: [Submitting a form with a file attachment](https://docs.apify.com/academy/puppeteer-playwright/common-use-cases/submitting-a-form-with-a-file-attachment.md)
---
