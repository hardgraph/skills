...
url: https://docs.apify.com/academy/scraping-basics-python/devtools-locating-elements.md
parents:
...
previous: [DevTools: Inspecting](https://docs.apify.com/academy/scraping-basics-python/devtools-inspecting.md)
next: [DevTools: Extracting data](https://docs.apify.com/academy/scraping-basics-python/devtools-extracting-data.md)
---
