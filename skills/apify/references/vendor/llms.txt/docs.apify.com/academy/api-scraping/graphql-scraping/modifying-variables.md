...
url: https://docs.apify.com/academy/api-scraping/graphql-scraping/modifying-variables.md
parents:
...
previous: [GraphQL scraping](https://docs.apify.com/academy/api-scraping/graphql-scraping.md)
next: [Introspection](https://docs.apify.com/academy/api-scraping/graphql-scraping/introspection.md)
---
