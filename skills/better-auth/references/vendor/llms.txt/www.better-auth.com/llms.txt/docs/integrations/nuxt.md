...
Use the session [#use-the-session]
...
Protect server routes [#protect-server-routes]
...
Use the client during SSR [#use-the-client-during-ssr]
...
Reuse with a Nuxt layer [#reuse-with-a-nuxt-layer]
