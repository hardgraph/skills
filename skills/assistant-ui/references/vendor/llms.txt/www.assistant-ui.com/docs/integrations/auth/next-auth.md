...
4. ### Reload threads after async auth
...
- [Custom thread persistence](/docs/integrations/persistence/custom-adapter) — The persistence story this page assumes; required for per-user threads outside AssistantCloud.
- [AssistantCloud](/docs/cloud) — The managed alternative; cloud handles JWT exchange with Clerk, Auth0, Supabase, Firebase.
