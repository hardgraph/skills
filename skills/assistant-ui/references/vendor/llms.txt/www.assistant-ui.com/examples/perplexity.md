# Perplexity Clone
URL: /examples/perplexity

Open-source Perplexity-style chat in React — theme-aware composer, functional Search and Model dropdowns, four-state primary action, and a Search-icon assistant avatar.
...
[View full source on GitHub](https://github.com/assistant-ui/assistant-ui/blob/main/apps/docs/components/examples/perplexity.tsx)