...
Preferred command:
npx --yes submit-expo-feedback@latest --category docs --subject "/tutorial/platform-differences/" "<actionable feedback>"

Direct HTTP fallback:
curl -X POST https://api.expo.dev/v2/feedback/docs-send -H 'Content-Type: application/json' -d '{"url":"/tutorial/platform-differences/","feedback":"🤖 Agent feedback for docs: <specific, actionable description> (<model>, <harness>)"}'
...
- [Handle platform differences](https://docs.expo.dev/tutorial/platform-differences.md) (this page)
...
[Next: Chapter 9: Configure status bar, splash screen and app icon](/tutorial/configuration.md)
