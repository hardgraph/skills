> For the complete documentation index, see [llms.txt](https://docs.n8n.io/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.n8n.io/build/manage-workflows/n8n-packages/import-a-package.md).
...
Import reads an [n8n package](/build/manage-workflows/n8n-packages.md), a [`.n8np` archive](/build/manage-workflows/n8n-packages/package-format.md), and writes its contents to the target instance. n8n checks the whole package first: if anything would block the import, it writes nothing and returns every problem at once. See [How import works](/build/manage-workflows/n8n-packages/how-import-works.md) for the detail.

Use the [n8n CLI](/connect/n8n-cli.md):
...
For the full request and response schema, see the `N8nPackage` section of the [endpoint reference](/connect/n8n-api/api-reference.md).
...
Publishing can also fail without failing the import, most often when two workflows want the same webhook path. See [Publishing outcomes](/build/manage-workflows/n8n-packages/how-import-works.md#publishing-outcomes).
...
For the ranking rules and the full resolution order, see [Credentials](/build/manage-workflows/n8n-packages/how-import-works.md#credentials).
...
`publishing.state` is one of `published`, `unpublished`, `unchanged`, `blocked`, or `failed`. For what each means, see [Publishing outcomes](/build/manage-workflows/n8n-packages/how-import-works.md#publishing-outcomes).
...
For the full list of reasons an import can be refused, and which status each returns, see [Why an import is refused](/build/manage-workflows/n8n-packages/how-import-works.md#why-an-import-is-refused).
...
* [How import works](/build/manage-workflows/n8n-packages/how-import-works.md) for the order n8n writes things in and how it resolves each entity type.
* [Export a package](/build/manage-workflows/n8n-packages/export-a-package.md) for the options that shape the package in the first place.
* [Limits and permissions](/build/manage-workflows/n8n-packages/limits-and-permissions.md) for upload caps and the full scope matrix.
