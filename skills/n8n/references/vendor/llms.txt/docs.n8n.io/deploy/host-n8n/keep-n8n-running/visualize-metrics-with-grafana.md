> For the complete documentation index, see [llms.txt](https://docs.n8n.io/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.n8n.io/deploy/host-n8n/keep-n8n-running/visualize-metrics-with-grafana.md).

# Visualize metrics with Grafana

Enable the Prometheus metrics endpoint in n8n, then connect Grafana through a Prometheus instance to visualize your n8n data. Refer to [Enable Prometheus metrics](/deploy/host-n8n/configure-n8n/basic-configuration/configuration-examples/enable-prometheus-metrics.md) before following this guide.
...
n8n publishes reusable grafana dashboards for several of the supported prometheus metrics in this GitHub project: [n8n-observability](https://github.com/n8n-io/n8n-observability)
