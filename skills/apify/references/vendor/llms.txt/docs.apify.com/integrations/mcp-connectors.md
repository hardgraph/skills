...
url: https://docs.apify.com/integrations/mcp-connectors.md
parents:
  - [Apify documentation](https://docs.apify.com/llms.txt)
  - [Integrations](https://docs.apify.com/integrations.md)
  - [AI](https://docs.apify.com/integrations/ai.md)
children:
  - [Build with connectors](https://docs.apify.com/integrations/mcp-connectors/use-in-actors.md)
previous: [Mastra](https://docs.apify.com/integrations/mastra.md)
next: [Build with connectors](https://docs.apify.com/integrations/mcp-connectors/use-in-actors.md)
---
...
2. When you run the Actor, you select an eligible connector in the input form. If you don't have one yet, you can create and authorize a new connector in advance under **Settings > API & Integrations** or inline within the Actor input.
3. When the Actor sends an MCP request to `ACTOR_MCP_CONNECTOR_BASE_URL/<connectorId>`, the Apify MCP Proxy validates the request, injects your credentials, and forwards it to the upstream MCP server the connector is authorized against.
...
For the developer-side controls and tool-permission model, see [Build Actors with MCP connectors](https://docs.apify.com/integrations/mcp-connectors/use-in-actors.md#tool-permissions).
...
* [Build Actors with MCP connectors](https://docs.apify.com/integrations/mcp-connectors/use-in-actors.md) - declare connectors in your input schema, connect from TypeScript or Python, and configure tool permissions.
* [Account settings - MCP connectors](https://docs.apify.com/account/settings.md#mcp-connectors) - create, authorize, and manage connectors in Apify Console.
* [Apify MCP server](https://docs.apify.com/integrations/mcp.md) - expose Apify Actors as MCP tools to outside AI clients.
