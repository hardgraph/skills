...
url: https://docs.apify.com/actors/running/standby.md
parents:
  - [Apify documentation](https://docs.apify.com/llms.txt)
  - [Actors](https://docs.apify.com/actors.md)
  - [Running Actors](https://docs.apify.com/actors/running.md)
previous: [Tasks](https://docs.apify.com/actors/running/tasks.md)
next: [Schedules](https://docs.apify.com/actors/running/schedules.md)
---
...
To authenticate requests to Actor Standby, follow the same process as [authenticating requests to the Apify API](https://docs.apify.com/integrations/api.md). You can provide your [API token](https://docs.apify.com/integrations/api.md#api-token) in one of two ways:

1. *Recommended*: Include the token in the `Authorization` header of your request as `Bearer <token>`. This approach is recommended because it prevents your token from being logged in server logs.
...
You can use [scoped tokens](https://docs.apify.com/integrations/api.md#limited-permissions) to send standby requests. This is useful for allowing third-party services to interact with your Actor without granting access to your entire account.

However, [restricting what an Actor can access](https://docs.apify.com/integrations/api.md#restricted-access-restrict-what-actors-can-access-using-the-scope-of-this-actor) using a scoped token is not supported when running in Standby mode.
...
See the [Actor Standby development section](https://docs.apify.com/actors/development/programming-interface/standby.md).
