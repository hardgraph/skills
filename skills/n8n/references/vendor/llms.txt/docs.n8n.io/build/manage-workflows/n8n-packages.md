> For the complete documentation index, see [llms.txt](https://docs.n8n.io/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.n8n.io/build/manage-workflows/n8n-packages.md).
...
A package is a gzipped tar archive with the `.n8np` extension. Inside it, each entity is a small JSON file, and a `manifest.json` lists what's in the package and what the target instance has to supply. See [Package format](/build/manage-workflows/n8n-packages/package-format.md) for the full layout.

Packages are an API feature. You export and import them through the [n8n API](/connect/n8n-api.md), or through the [n8n CLI](/connect/n8n-cli.md), which wraps the same two endpoints. There's no way to export or import a package from the n8n editor.
...
{% content-ref url="/pages/4Uh1HEX4h8h4xICSPleZ" %}
[Package format](/build/manage-workflows/n8n-packages/package-format.md)
{% endcontent-ref %}

{% content-ref url="/pages/e6SsmL3Q69WHaqgzuJuu" %}
[Export a package](/build/manage-workflows/n8n-packages/export-a-package.md)
{% endcontent-ref %}

{% content-ref url="/pages/JYsflBnr4iMscE1xNk6o" %}
[Import a package](/build/manage-workflows/n8n-packages/import-a-package.md)
{% endcontent-ref %}

{% content-ref url="/pages/lI9bYDLmGfD1SyKBR3LZ" %}
[How import works](/build/manage-workflows/n8n-packages/how-import-works.md)
{% endcontent-ref %}

{% content-ref url="/pages/vt71EyGO5Pqf2vuNXA0s" %}
[Limits and permissions](/build/manage-workflows/n8n-packages/limits-and-permissions.md)
{% endcontent-ref %}

For other ways to move a workflow, including copy and paste and the editor's download and import options, see [Export and import](/build/manage-workflows/export-and-import.md).
