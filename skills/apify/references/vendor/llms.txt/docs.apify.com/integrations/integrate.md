...
url: https://docs.apify.com/integrations/integrate.md
parents:
  - [Apify documentation](https://docs.apify.com/llms.txt)
  - [Integrations](https://docs.apify.com/integrations.md)
previous: [Overview](https://docs.apify.com/integrations.md)
next: [Actor-to-Actor](https://docs.apify.com/integrations/actors.md)
---
...
* [Zapier](https://docs.apify.com/integrations/zapier.md) integration allows Zapier users to enrich their automation workflows with data from the web or to add additional Actions performed by [Apify Actors](https://apify.com/store).
* [Keboola](https://docs.apify.com/integrations/keboola.md) integration enables Keboola users to easily pull data crawled from the web into their data pipelines.
...
For more examples both general and Actor-specific, check [integrations](https://docs.apify.com/integrations.md).
...
![Keboola Apify component](/assets/images/keboola-components-e902b830867152bff6fa84fd58fbfdea.png)
...
*API token* - Apify user generates personal API token from Apify account settings page. For more information, see [API Token documentation](https://docs.apify.com/integrations/api#api-token).
...
* *Select Actor runs to watch*: Dropdown (list of user's Actors). Populated via [List Actors API](https://docs.apify.com/api/v2/actors-get)
