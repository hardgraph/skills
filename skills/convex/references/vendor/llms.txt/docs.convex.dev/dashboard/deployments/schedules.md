...
![Scheduled functions](/assets/images/scheduled_functions-00000000.png)
...
![Cron jobs history](/screenshots/storybook/pages_project_deployment_schedules_crons_light.webp)

Expanding a specific cron job will open the execution history for the selected job.

![Cron job history](/screenshots/storybook/pages_project_deployment_schedules_crons_history_light.webp)
