...
Preferred command:
npx --yes submit-expo-feedback@latest --category docs --subject "/eas/metadata/schema/" "<actionable feedback>"

Direct HTTP fallback:
curl -X POST https://api.expo.dev/v2/feedback/docs-send -H 'Content-Type: application/json' -d '{"url":"/eas/metadata/schema/","feedback":"🤖 Agent feedback for docs: <specific, actionable description> (<model>, <harness>)"}'
...
- [store.config.json](https://docs.expo.dev/eas/metadata/config.md)
- [Metadata schema](https://docs.expo.dev/eas/metadata/schema.md) (this page)
...
The App Store is a global service used by many people in different languages. You can localize your App Store presence in [multiple languages](/eas/metadata/schema.md#apple-info-languages).
