> For the complete documentation index, see [llms.txt](https://docs.n8n.io/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.n8n.io/connect/create-nodes/build-your-node/reference/node-ui-elements.md).
...
![String](/files/9D9KQSVCIHVNTuP9BtAS)
...
![Password](/files/7D0rQAozFsTjgLzjVHqp)
...
![Multiple rows](/files/9IUQq64Y1lIzDmhobLb1)
...
![Decimal](/files/J4aJSCWEEjs1RzsXzSRY)
...
![Collection](/files/CoUZBYzXfMhNdr19jmIi)
...
![DateTime](/files/nKl7kDBWv6rH5GWagXq9)
...
![Boolean](/files/QFSeHVfNLk9ssot7DtKk)
...
![Color](/files/omthgbCp46SjONZBhMg1)
...
![Options](/files/Vwas9OySKVnEeKzE9DlE)
...
![Multi-options](/files/k2WKZaZ5FjRNJPEB1RSk)
...
![Filter](/files/nE6GFhfYOe8I2xREKH5n)
...
![A gif showing the drag and drop action, as well as changing a field to fixed](/files/l661cEAELNZbAIRubrfN)
...
![Fixed collection](/files/jH1eqKyViQ8r8WQBL48Y)

## Resource locator <a href="#resource-locator" id="resource-locator"></a>

![Resource locator](/files/s7StewkxpU2yHlnr3ZOW)
...
![JSON](/files/aAkdKIMdv2gvX0cxPdKu)
...
Display a yellow box with a hint or extra info. Refer to [Node UI design](/connect/create-nodes/plan-your-node/node-ui-design.md) for guidance on writing good hints and info text.
...
![Notice](/files/5zk4jEbpyTkdeu5xWuOr)
