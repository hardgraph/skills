...
url: https://docs.apify.com/actors/development/actor-definition/output-schema.md
parents:
...
previous: [Custom error messages](https://docs.apify.com/actors/development/actor-definition/input-schema/custom-error-messages.md)
next: [Web server schema](https://docs.apify.com/actors/development/actor-definition/web-server-schema.md)
---
...
2. Creating the final output URL from the interpolated template
...
The output schema defines *where* data is stored and how to access it. The [dataset schema](https://docs.apify.com/storage/dataset-schema.md) defines *what* fields each item contains, including descriptions and examples. Use both schemas together:
...
![Video files in Output tab](/assets/images/output-schema-combination-example-7bf6dde746e0b90b1bf4ee2db2a22b3f.png)
