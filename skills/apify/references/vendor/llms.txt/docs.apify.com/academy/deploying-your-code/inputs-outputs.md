...
url: https://docs.apify.com/academy/deploying-your-code/inputs-outputs.md
parents:
...
previous: [Deploying your code to Apify](https://docs.apify.com/academy/deploying-your-code.md)
next: [How to write Actor input schema](https://docs.apify.com/academy/deploying-your-code/input-schema.md)
---
