...
url: https://docs.apify.com/actors/publishing/actor-readme.md
parents:
  - [Apify documentation](https://docs.apify.com/llms.txt)
  - [Actors](https://docs.apify.com/actors.md)
  - [Publishing and monetization](https://docs.apify.com/actors/publishing.md)
  - [Publish your Actor](https://docs.apify.com/actors/publishing/publish.md)
previous: [Publish your Actor](https://docs.apify.com/actors/publishing/publish.md)
next: [Publish your Actor task](https://docs.apify.com/actors/publishing/publish-task.md)
---
...
Every [Actor template](https://apify.com/templates) ships with a `README.md` file that includes instructions on setting up the project locally. Once you're ready to [publish your Actor](https://docs.apify.com/actors/publishing/publish.md), edit the file and replace the default content with information aimed at potential users.
...
```md
[![Image description](path/to/image.png)](https://console.apify.com/sign-up)
```
...
See also [How to create a great input schema](https://docs.apify.com/academy/actor-marketing-playbook/product-optimization/how-to-create-a-great-input-schema.md).
