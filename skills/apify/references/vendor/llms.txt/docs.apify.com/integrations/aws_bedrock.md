...
url: https://docs.apify.com/integrations/aws_bedrock.md
parents:
  - [Apify documentation](https://docs.apify.com/llms.txt)
  - [Integrations](https://docs.apify.com/integrations.md)
  - [AI](https://docs.apify.com/integrations/ai.md)
previous: [Agno](https://docs.apify.com/integrations/agno.md)
next: [Claude](https://docs.apify.com/integrations/claude.md)
---
...
* An Apify account and an [API token](https://docs.apify.com/integrations/api#api-token).
