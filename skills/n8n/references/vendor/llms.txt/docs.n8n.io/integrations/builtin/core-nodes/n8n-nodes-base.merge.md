> For the complete documentation index, see [llms.txt](https://docs.n8n.io/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.merge.md).
...
<figure><img src="/files/dec49pTpgVAOgfFdofkE" alt=""><figcaption><p>Append mode inputs and output</p></figcaption></figure>
...
<figure><img src="/files/TwpI3gRY29QyVCdYdnRG" alt=""><figcaption><p>Combine by Matching Fields mode inputs and output</p></figcaption></figure>
...
<figure><img src="/files/Ysd1ldUvnmENtkBKD0Yv" alt=""><figcaption><p>Combine by Position mode inputs and output</p></figcaption></figure>
...
<figure><img src="/files/pQI5W01vOwCFW6AUp7UB" alt=""><figcaption><p>Combine by All Possible Combinations mode inputs and output</p></figcaption></figure>
...
![Screenshot of a workflow. The workflow has an Edit Fields node, followed by an If node. It ends with a Merge node.](/spaces/GixZThfitWP21x2gQFpD/files/aooCX8gUoqPEvfpHVvnx)
