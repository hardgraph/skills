...
url: https://docs.apify.com/academy/scraping-basics-javascript/saving-data.md
parents:
...
previous: [Extracting data from HTML](https://docs.apify.com/academy/scraping-basics-javascript/extracting-data.md)
next: [Getting links from HTML](https://docs.apify.com/academy/scraping-basics-javascript/getting-links.md)
---
