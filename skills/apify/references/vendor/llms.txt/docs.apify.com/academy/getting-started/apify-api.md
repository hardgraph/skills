---
title: The Apify API
url: https://docs.apify.com/academy/getting-started/apify-api.md
parents:
  - [Apify documentation](https://docs.apify.com/llms.txt)
  - [Apify Academy](https://docs.apify.com/academy.md)
  - [Getting started](https://docs.apify.com/academy/getting-started.md)
previous: [Inputs & outputs](https://docs.apify.com/academy/getting-started/inputs-outputs.md)
next: [Apify client](https://docs.apify.com/academy/getting-started/apify-client.md)
---
...
![The \&quot;API\&quot; button on an Actor\&#39;s page in Apify Console](/assets/images/api-tab-1fb75598685ed64e58605cd51734d19c.jpg)
...
Additional parameters can be passed to this endpoint. You can learn about them in our [API documentation](https://docs.apify.com/api/v2/actor-run-sync-get-dataset-items-post.md)
