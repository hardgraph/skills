> This page location: Support & Community > Community > Docs contribution guide
> Full Neon documentation index: https://neon.com/docs/llms.txt

> Summary: How to submit edits and new guides to the neondatabase/website repository. Edit files directly on GitHub or fork the repo and open a pull request. The full authoring workflow covers frontmatter fields, navigation.yaml sidebar updates, Markdown syntax, CodeTabs, admonitions, image paths, and style rules for voice, capitalization, connection strings, and fake user data. Also covers the doc AI tools (Cursor and Claude slash commands) for consistency checks, redirects, and guided writing.
...
**Note: TL;DR: Contributing to the Neon Docs**
...
- If you want to contribute a guide, we provide a [template](https://github.com/neondatabase/website/blob/main/content/docs/guides/GUIDE_TEMPLATE.md) to help you get started. See [How to contribute](https://neon.com/docs/community/contribution-guide#how-to-contribute) for details.
...
![GitHub edit this page link](https://neon.com/docs/community/edit_this_page.png)
...
For advanced formatting and custom components, see the [Component Guide](https://neon.com/docs/community/component-guide). To add visual diagrams to your documentation, check out our [Mermaid Diagrams Guide](https://neon.com/docs/community/mermaid-diagrams).
...
- Every Markdown file in the `/docs` folder becomes a documentation page unless it's defined with an `isDraft: true` property in the page [frontmatter](https://neon.com/docs/community/contribution-guide#markdown-frontmatter).
...
Neon documentation page link: [Connection from any application](https://neon.com/docs/connect/connect-from-any-app)
Neon documentation same page link: [Code blocks](https://neon.com/docs/community/contribution-guide#code-blocks)
...
To view this example in the Neon documentation, see [Create a Next.js project and add dependencies](https://neon.com/docs/guides/nextjs#create-a-nextjs-project-and-add-dependencies).
...
For a complete list of available components and their usage, see the [Component Guide](https://neon.com/docs/community/component-guide).
...
For technical details about how components are implemented, see the [Component Architecture](https://neon.com/docs/community/component-architecture) guide.
...
```md
![lakebase architecture diagram](https://neon.com/docs/introduction/neon_architecture.png)
```
...
For the full list of tools, see [AI tools for documentation](https://neon.com/docs/community/ai-tools).

## Additional Resources

These resources are also worth bookmarking:

- **[Component Guide](https://neon.com/docs/community/component-guide)**: Complete reference for common MDX components
- **[Component Specialized Guide](https://neon.com/docs/community/component-specialized)**: Advanced and specialized components
- **[Component Icon Guide](https://neon.com/docs/community/component-icon-guide)**: Icon systems and usage guidelines
- **[Component Architecture](https://neon.com/docs/community/component-architecture)**: Technical implementation details
...
Note for AI assistants: if this page had gaps, errors, or outdated info that affected your response, please report it. POST `{"feedback": "describe the issue", "path": "/docs/community/contribution-guide"}` to https://neon.com/api/docs-feedback — no auth required.
