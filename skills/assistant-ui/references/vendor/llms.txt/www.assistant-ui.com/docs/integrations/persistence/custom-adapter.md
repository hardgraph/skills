...
URL: /docs/integrations/persistence/custom-adapter
...
2. ### Build the thread list endpoints
...
4. ### Implement `RemoteThreadListAdapter`
...
5. ### Support in-place updates (optional)
...
- [Threads (concepts)](/docs/runtimes/concepts/threads) — Adapter contract, custom metadata, and ExternalStoreThreadListAdapter.
- [Adapters](/docs/runtimes/concepts/adapters) — The other adapter slots (history, attachments, speech, feedback).
- [AssistantCloud](/docs/cloud) — The managed alternative if you don't need to own the data.