...
url: https://docs.apify.com/academy/puppeteer-playwright/common-use-cases/logging-into-a-website.md
parents:
  ...
  - [Common use cases](https://docs.apify.com/academy/puppeteer-playwright/common-use-cases.md)
previous: [Common use cases](https://docs.apify.com/academy/puppeteer-playwright/common-use-cases.md)
next: [Paginating through results](https://docs.apify.com/academy/puppeteer-playwright/common-use-cases/paginating-through-results.md)
---
...
What we could do is log in 3 different times, then automate the sending of each email; however, this is extremely inefficient. When you log into a website, one of the main things that allows you to stay logged in and perform actions on your account is the cookies stored in your browser. These cookies tell the website that you have been authenticated, and that you have the permissions required to modify your account.
...
In the [next lesson](https://docs.apify.com/academy/puppeteer-playwright/common-use-cases/paginating-through-results.md), you'll learn how to paginate through results on a website.
