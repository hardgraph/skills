...
url: https://docs.apify.com/academy/puppeteer-playwright/executing-scripts/injecting-code.md
parents:
...
previous: [III - Executing scripts](https://docs.apify.com/academy/puppeteer-playwright/executing-scripts.md)
next: [Extracting data](https://docs.apify.com/academy/puppeteer-playwright/executing-scripts/collecting-data.md)
---
