> For the complete documentation index, see [llms.txt](https://docs.n8n.io/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.n8n.io/connect/create-nodes/build-your-node/using-the-n8n-node-tool.md).
...
Using `n8n-node`, you can create nodes that adhere to the [guidelines for verified community nodes](/connect/create-nodes/build-your-node/reference/verification-guidelines.md).
...
* **What kind of node are you building?** The [node type](/connect/create-nodes/plan-your-node/choose-a-node-building-style.md) you want to build:
...
![node in nodes panel](/files/koSRH7tMLWu3Da4lQwDs)
