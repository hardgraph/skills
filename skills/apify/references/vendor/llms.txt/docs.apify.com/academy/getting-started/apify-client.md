---
title: Apify client
url: https://docs.apify.com/academy/getting-started/apify-client.md
parents:
  - [Apify documentation](https://docs.apify.com/llms.txt)
  - [Apify Academy](https://docs.apify.com/academy.md)
  - [Getting started](https://docs.apify.com/academy/getting-started.md)
previous: [The Apify API](https://docs.apify.com/academy/getting-started/apify-api.md)
next: [Deploying your code to Apify](https://docs.apify.com/academy/deploying-your-code.md)
---
