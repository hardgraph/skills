# Clerk
URL: /docs/integrations/auth/clerk
...
2. ### Scope thread queries by user
...
3. ### Reload threads after async auth
...
- [AssistantCloud authorization](/docs/cloud/authorization) — The cloud-managed alternative: Clerk JWT template plus workspace scoping, no DB code.
