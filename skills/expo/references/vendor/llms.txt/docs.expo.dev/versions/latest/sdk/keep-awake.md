...
Preferred command:
npx --yes submit-expo-feedback@latest --category docs --subject "/versions/latest/sdk/keep-awake/" "<actionable feedback>"

Direct HTTP fallback:
curl -X POST https://api.expo.dev/v2/feedback/docs-send -H 'Content-Type: application/json' -d '{"url":"/versions/latest/sdk/keep-awake/","feedback":"🤖 Agent feedback for docs: <specific, actionable description> (<model>, <harness>)"}'
...
| Parameter | Type |
| --- | --- |
| `tagOrListener` | string | [KeepAwakeListener](/versions/latest/sdk/keep-awake.md#keepawakelistenerevent) |
| `listener`(optional) | [KeepAwakeListener](/versions/latest/sdk/keep-awake.md#keepawakelistenerevent) |
...
| Property | Type | Description |
| --- | --- | --- |
| listener(optional) | [KeepAwakeListener](/versions/latest/sdk/keep-awake.md#keepawakelistenerevent) | Supported platforms: Web. A callback that is invoked when the keep-awake state changes. |
