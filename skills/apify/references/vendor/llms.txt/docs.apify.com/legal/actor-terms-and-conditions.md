---
title: Actor Terms and Conditions
url: https://docs.apify.com/legal/actor-terms-and-conditions.md
parents:
  - [Apify documentation](https://docs.apify.com/llms.txt)
  - [Apify Legal](https://docs.apify.com/legal.md)
previous: [General Terms](https://docs.apify.com/legal/general-terms-and-conditions.md)
next: [Apify Store Publishing Terms](https://docs.apify.com/legal/store-publishing-terms-and-conditions.md)
---
...
4.1. Subject to the permission level you grant to an Actor in your Account, you authorize us to share your Account information and Customer Data with the Creator, to the extent the Actor is able to access them at that permission level. You acknowledge that Creator shall not be considered our Subprocessors as defined in the [Apify Data Processing Addendum](https://docs.apify.com/legal/data-processing-addendum.md).
