> For the complete documentation index, see [llms.txt](https://docs.n8n.io/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.n8n.io/contribute/contribution-guide-for-n8n-docs.md).
...
n8n Docs uses a few distinct page types. Understanding which type you're working with helps you follow the right structure and use the correct template. Each type has a template in the [`document-templates/`](https://github.com/n8n-io/n8n-docs/tree/main/document-templates/README.md) folder:
...
![GitBook preview link on a pull request](/files/yFaTzTXRINO5cu8aoN8s)
...
![GitBook page previews comment on a pull request](/files/yPXBYKzUAqQM1aG3tepK)
