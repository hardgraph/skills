...
See [Native Bottom Tabs Navigator](native-bottom-tab-navigator.md) for a native implementation that uses native primitives on Android & iOS, including platform styling such as Liquid Glass on iOS >= 26.
