...
Preferred command:
npx --yes submit-expo-feedback@latest --category docs --subject "/eas/environment-variables/faq/" "<actionable feedback>"

Direct HTTP fallback:
curl -X POST https://api.expo.dev/v2/feedback/docs-send -H 'Content-Type: application/json' -d '{"url":"/eas/environment-variables/faq/","feedback":"🤖 Agent feedback for docs: <specific, actionable description> (<model>, <harness>)"}'
...
- [FAQ](https://docs.expo.dev/eas/environment-variables/faq.md) (this page)
...
Explicitly set the [`environment`](/eas/json.md#environment) value in **eas.json** for your build profiles to ensure that the correct environment variables are always used for your build jobs and you have full control over this process.
...
-   [Custom environments](/eas/environment-variables/manage.md#custom-environments) are limited to 10 per project.
