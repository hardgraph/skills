...
url: https://docs.apify.com/integrations/zapier.md
parents:
...
previous: [Workato](https://docs.apify.com/integrations/workato.md)
---
...
> Sets a value to a [Key-value store](https://docs.apify.com/storage/key-value-store.md).

## Searches

### Fetch dataset items

> Retrieves items from a [dataset](https://docs.apify.com/storage/dataset.md).
...
> Retrieves value from a [Key-value store](https://docs.apify.com/storage/key-value-store.md).
