> For the complete documentation index, see [llms.txt](https://docs.n8n.io/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.n8n.io/changelog/release-notes-2.x.md).
...
You can find the release notes for older versions of n8n: [1.x](/changelog/release-notes-1.x.md) and [0.x](/changelog/release-notes-0.x.md)
{% endhint %}
...
<img src="/files/88R0fKYYOnxlFWA64gMB" alt="A Microsoft Agent 365 Trigger node with a chat model, memory, and tools across Zendesk, Salesforce, PagerDuty, Datadog, and a sub-workflow." data-size="original">

#### How it works <a href="#how-it-works" id="how-it-works"></a>

You build the agent in n8n using the Microsoft Agent 365 Trigger node:

* Add a system prompt and give the agent access to tools, MCP servers, and your existing workflows using [sub-workflows as tools](/build/flow-logic/break-workflows-into-smaller-parts.md).
...
Refer to [External secrets](/administer/manage-credentials/use-external-secret-stores.md) for more information. Project-scoped external secrets are available on n8n Enterprise.
...
Folder-based filtering is available on n8n Enterprise (requires [Environments](/administer/use-source-control-and-environments/set-up-source-control.md) configured).
...
<figure><img src="/files/Xh2ItSd6fy71UbxFdBd8" alt=""><figcaption><p>Setting up Slack credentials with managed OAuth.</p></figcaption></figure>
...
You can now set up more than one connection for a single [external secrets](/administer/manage-credentials/use-external-secret-stores.md) provider. The updated UI makes it easier to configure and manage multiple connections under the same provider type.
...
This release builds on the recent updates to the permissions model, including [custom project roles](/administer/manage-users-and-access/set-permissions-and-roles-rbac/create-custom-roles.md), to better support policy-driven governance.

Personal space policies are available on n8n Enterprise.

<img src="/files/3HivOcFAvSmZMgaAb3Zc" alt="The new Security &#x26; policies settings section." data-size="original">
...
<img src="/files/JTqdxl2jnWEfk1ui9NxA" alt="System roles and custom roles are now displayed in separate sections." data-size="original">
{% endhint %}
...
\
Get precise control over where human judgment is required, without limiting what your agent can do. Learn more [here](/build/integrate-ai/ai-examples/human-in-the-loop-for-tools.md).
{% endhint %}
...
<img src="/files/V3qufQBMeHFvbNU0wFdz" alt="Custom Project Roles" data-size="original"><br>
...
![time saved node example](/files/8sopBMwDysCOXgxjqM8r)
...
![insights dashboard](/files/xEp5ScspoCNJvC3p8GX8)
