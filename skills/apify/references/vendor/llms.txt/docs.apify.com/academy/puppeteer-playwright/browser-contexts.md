...
url: https://docs.apify.com/academy/puppeteer-playwright/browser-contexts.md
parents:
...
previous: [V - Using proxies](https://docs.apify.com/academy/puppeteer-playwright/proxies.md)
next: [Common use cases](https://docs.apify.com/academy/puppeteer-playwright/common-use-cases.md)
---
