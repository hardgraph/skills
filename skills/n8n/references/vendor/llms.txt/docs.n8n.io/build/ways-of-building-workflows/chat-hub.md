...
3. Only workflows with [Chat Trigger node](/integrations/builtin/core-nodes/n8n-nodes-langchain.chattrigger.md) and streaming-enabled [AI Agent node](/integrations/builtin/cluster-nodes/root-nodes/n8n-nodes-langchain.agent.md) work as workflow agents. Your workflows must meet specific requirements.
