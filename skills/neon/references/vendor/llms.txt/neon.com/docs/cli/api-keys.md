> This page location: APIs & SDKs > CLI > Setup and context > api-keys
...
For key types, revocation permissions, and rotation, see [Manage API keys](https://neon.com/docs/manage/api-keys).

Subcommands: [create](https://neon.com/docs/cli/api-keys#create), [list](https://neon.com/docs/cli/api-keys#list), [revoke](https://neon.com/docs/cli/api-keys#revoke)
...
Takes the numeric key ID, not the name. Organization and project-scoped keys need organization admin permissions. See [who can revoke keys](https://neon.com/docs/manage/api-keys#who-can-revoke-keys).
