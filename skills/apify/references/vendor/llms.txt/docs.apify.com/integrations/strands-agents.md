...
url: https://docs.apify.com/integrations/strands-agents.md
parents:
  - [Apify documentation](https://docs.apify.com/llms.txt)
  - [Integrations](https://docs.apify.com/integrations.md)
  - [AI](https://docs.apify.com/integrations/ai.md)
previous: [Skyfire](https://docs.apify.com/integrations/skyfire.md)
next: [Upsonic](https://docs.apify.com/integrations/upsonic.md)
---
...
Run a saved [Actor task](https://docs.apify.com/actors/running/tasks.md) with optional input overrides. Tasks are pre-configured Actor runs saved in Apify Console.
