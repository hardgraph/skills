...
Preferred command:
npx --yes submit-expo-feedback@latest --category docs --subject "/tutorial/introduction/" "<actionable feedback>"

Direct HTTP fallback:
curl -X POST https://api.expo.dev/v2/feedback/docs-send -H 'Content-Type: application/json' -d '{"url":"/tutorial/introduction/","feedback":"🤖 Agent feedback for docs: <specific, actionable description> (<model>, <harness>)"}'
...
- [Introduction](https://docs.expo.dev/tutorial/introduction.md) (this page)
...
> **New to programming?** You can build this same app by prompting an AI coding agent instead of writing the code yourself. Follow the [Build with AI tutorial](/tutorial/build-with-ai/introduction.md). It covers setup from scratch.
...
[Start](/tutorial/create-your-first-app.md) — Let's start by creating a new Expo app.
