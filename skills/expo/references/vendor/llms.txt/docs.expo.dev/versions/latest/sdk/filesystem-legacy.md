...
sourceCodeUrl: 'https://github.com/expo/expo/tree/sdk-57/packages/expo-file-system/src/legacy'
...
Preferred command:
npx --yes submit-expo-feedback@latest --category docs --subject "/versions/latest/sdk/filesystem-legacy/" "<actionable feedback>"

Direct HTTP fallback:
curl -X POST https://api.expo.dev/v2/feedback/docs-send -H 'Content-Type: application/json' -d '{"url":"/versions/latest/sdk/filesystem-legacy/","feedback":"🤖 Agent feedback for docs: <specific, actionable description> (<model>, <harness>)"}'
...
-   [`FileSystem.documentDirectory`](/versions/latest/sdk/filesystem-legacy.md#filesystem-legacydocumentdirectory)
-   [`FileSystem.cacheDirectory`](/versions/latest/sdk/filesystem-legacy.md#filesystem-legacycachedirectory)
...
A SAF URI is a URI that is compatible with the Storage Access Framework. It should look like this `content://com.android.externalstorage.*`. The easiest way to obtain such URI is by [`requestDirectoryPermissionsAsync`](/versions/latest/sdk/filesystem-legacy.md#requestdirectorypermissionsasyncinitialfileurl) method.
...
| `readAsStringAsync` | `file:///`,`asset://`,[SAF URI](/versions/latest/sdk/filesystem-legacy.md#saf-uri) | `file://` |
| `writeAsStringAsync` | `file:///`,[SAF URI](/versions/latest/sdk/filesystem-legacy.md#saf-uri) | `file://` |
| `deleteAsync` | `file:///`,[SAF URI](/versions/latest/sdk/filesystem-legacy.md#saf-uri) | `file://` |
| `moveAsync` | Source:`file:///`,[SAF URI](/versions/latest/sdk/filesystem-legacy.md#saf-uri)Destination:`file://` | Source:`file://`Destination:`file://` |
| `copyAsync` | Source:`file:///`,`content://`,`asset://`,[SAF URI](/versions/latest/sdk/filesystem-legacy.md#saf-uri),no schemeDestination:`file://` | Source:`file://`,`ph://`,`assets-library://`Destination:`file://` |
