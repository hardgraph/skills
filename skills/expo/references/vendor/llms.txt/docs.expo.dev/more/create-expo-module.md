...
Preferred command:
npx --yes submit-expo-feedback@latest --category docs --subject "/more/create-expo-module/" "<actionable feedback>"

Direct HTTP fallback:
curl -X POST https://api.expo.dev/v2/feedback/docs-send -H 'Content-Type: application/json' -d '{"url":"/more/create-expo-module/","feedback":"🤖 Agent feedback for docs: <specific, actionable description> (<model>, <harness>)"}'
...
- [create-expo-module](https://docs.expo.dev/more/create-expo-module.md) (this page)
...
[Expo Modules API: Get started](/modules/get-started.md) — Learn how to create and use local and standalone Expo modules.

[expo-module.config.json](/modules/module-config.md) — Understand the module configuration file used by Expo Autolinking.

[How to use a standalone Expo module](/modules/use-standalone-expo-module-in-your-project.md) — See how to use standalone modules in monorepos and publish them to npm.
