...
url: https://docs.apify.com/academy/advanced-web-scraping/crawling/crawling-with-search.md
parents:
  - [Apify documentation](https://docs.apify.com/llms.txt)
  - [Apify Academy](https://docs.apify.com/academy.md)
  - [Advanced web scraping](https://docs.apify.com/academy/advanced-web-scraping.md)
previous: [Crawling sitemaps](https://docs.apify.com/academy/advanced-web-scraping/crawling/crawling-sitemaps.md)
next: [Web scraping basics with JS (old)](https://docs.apify.com/academy/scraping-basics-javascript/legacy.md)
---
...
If the website supports only overlapping ranges (e.g. **$0-$5**, **$5–10**), it is not a big problem. Only a small portion of the listings will be duplicates, and they can be removed using a [request queue](https://docs.apify.com/storage/request-queue.md).
