...
```bash
npx shadcn@latest add @assistant-ui/card @assistant-ui/button
```

Or add by direct URL without registry configuration:

```bash
npx shadcn@latest add https://r.assistant-ui.com/base/card.json https://r.assistant-ui.com/base/button.json
```
