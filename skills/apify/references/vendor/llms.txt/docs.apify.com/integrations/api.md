...
url: https://docs.apify.com/integrations/api.md
parents:
  - [Apify documentation](https://docs.apify.com/llms.txt)
  - [Integrations](https://docs.apify.com/integrations.md)
  - [Programming](https://docs.apify.com/integrations/programming.md)
previous: [Programming](https://docs.apify.com/integrations/programming.md)
next: [GitHub](https://docs.apify.com/integrations/github.md)
---
...
All aspects of the Apify platform can be controlled via a REST API, which is described in detail in the [API Reference](https://docs.apify.com/api/v2.md). If you want to use the Apify API from JavaScript/Node.js or Python, we strongly recommend using one of the API clients:

* [apify-client](https://docs.apify.com/api/client/js) `npm` package for JavaScript, supporting both browser and server
* [apify-client](https://docs.apify.com/api/client/python) PyPI package for Python.
...
![Integrations page in Apify Console](/assets/images/api-token-c1ace583e58bda1c69d76a93297349f8.png)

Protect your API token

Do not share the API token with untrusted parties, or use it directly from client-side code, unless you fully understand the consequences! You can also consider limiting the permission scope of the token, so that it can only access what it really needs.
...
Note that some API endpoints, such as [Get list of keys](https://docs.apify.com/api/v2/key-value-store-keys-get.md), do not require an authentication token because they contain a hard-to-guess identifier that effectively serves as an authentication key.
...
![Creating token with expiration date in Apify Console](/assets/images/api-token-expiration-date-422b4f0433871dbeee59a23d06010f21.png)
...
![Rotate token in Apify Console](/assets/images/api-token-rotate-6c21e1e4fc3f5507882868822a71b6a4.png)
...
![Leaked token in Apify Console](/assets/images/api-token-leaked-6ce9b9ea14aa76a1109fab863259da85.png)

## Organization accounts

When working under an organization account, you will see two types of API tokens on the API & Integrations page.

![Integrations page in Apify Console in organization mode](/assets/images/api-token-organization-e3655a759e0010b2015b3cb4f9a2b2b2.png)
...
Actor modification restrictions
...
![Toggle \&quot;Limit token permissions\&quot; to make a token scoped](/assets/images/api-token-scoped-1924cb0bcb243160c2c0e3db9d7e31b8.png)
...
![An example scoped token that combines account-level permissions and resource-specific permissions](/assets/images/api-token-scoped-with-combining-permissions-2a215b511b0705b7617fe154df80ed15.png)
...
![The Write permission depends on Read for a dataset](/assets/images/api-token-scoped-dependencies-0af67b93c684001175ddc3f273eff652.png)
...
![Choose permission mode for running Actors with a scoped token](/assets/images/api-token-scoped-run-modes-7d0d9163f379ea085781f96e34295844.png)
...
Standby mode limitation

Restricted access mode is not supported for Actors running in [Standby mode](https://docs.apify.com/actors/running/standby.md). While you can send standby requests using a scoped token configured with restricted access, functionality is not guaranteed.
...
When Apify [runs an Actor](https://docs.apify.com/actors/running/runs-and-builds.md#runs), it automatically creates a set of default storages (a dataset, a key-value store and request queue) that the Actor can use in runtime.
...
![Configure whether the trigger token gets write access to the run default storages.](/assets/images/api-token-scoped-default-storage-access-5b35df1f6168356aeb9029192f9572e8.png)
...
* For accounts with **Restricted general resource access**, the token cannot read or write to default storages. [Learn more about restricted general resource access](https://docs.apify.com/account/collaboration/general-resource-access.md).
...
![Scoped token configured to run a task](/assets/images/api-token-scoped-run-tasks-ef961ddca69d18ff3797ee47ccafe44e.png)

Refer to this section to understand how permission dependencies work.
...
![Scoped token with Restricted access](/assets/images/api-token-scoped-restricted-access-active-bdd6f312a8bf9ea7e8dfbe2e31c3df60.png)
...
Refer to Actor execution section to understand how executing Actors with scoped tokens works.
