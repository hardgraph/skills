...
5. If you're using this credential for the [Slack Trigger](/integrations/builtin/trigger-nodes/n8n-nodes-base.slacktrigger.md), follow the steps in [Slack Trigger configuration](#slack-trigger-configuration) to finish setting up your app.
...
The **Signature Secret** field is also required for [Approvals in Slack](/integrations/builtin/app-nodes/n8n-nodes-base.slack/approvals.md).
