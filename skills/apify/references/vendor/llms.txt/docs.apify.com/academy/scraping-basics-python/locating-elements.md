...
url: https://docs.apify.com/academy/scraping-basics-python/locating-elements.md
parents:
...
previous: [Parsing HTML](https://docs.apify.com/academy/scraping-basics-python/parsing-html.md)
next: [Extracting data from HTML](https://docs.apify.com/academy/scraping-basics-python/extracting-data.md)
---
