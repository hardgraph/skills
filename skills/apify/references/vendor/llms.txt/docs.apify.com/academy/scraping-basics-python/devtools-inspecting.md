...
url: https://docs.apify.com/academy/scraping-basics-python/devtools-inspecting.md
parents:
...
previous: [Web scraping basics with Python](https://docs.apify.com/academy/scraping-basics-python.md)
next: [DevTools: Locating HTML elements](https://docs.apify.com/academy/scraping-basics-python/devtools-locating-elements.md)
---
