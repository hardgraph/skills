> For the complete documentation index, see [llms.txt](https://docs.n8n.io/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.n8n.io/administer/manage-users-and-access/set-permissions-and-roles-rbac/create-custom-roles/create-custom-project-roles.md).
...
**Custom instance roles**: Roles that relate to the administrative capabilities a user needs at the instance level. Refer to [Create custom instance roles](/administer/manage-users-and-access/set-permissions-and-roles-rbac/create-custom-roles/create-custom-instance-roles.md).
...
* `workflow:enableRedaction` - Turn on data redaction for a workflow (refer to [Execution data redaction](/deploy/host-n8n/configure-n8n/security/redact-execution-data.md))
* `workflow:disableRedaction` - Turn off data redaction for a workflow (refer to [Execution data redaction](/deploy/host-n8n/configure-n8n/security/redact-execution-data.md))
...
* `execution:reveal` - Reveal redacted execution data (refer to [Execution data redaction](/deploy/host-n8n/configure-n8n/security/redact-execution-data.md))
