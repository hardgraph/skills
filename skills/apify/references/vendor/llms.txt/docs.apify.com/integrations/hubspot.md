...
url: https://docs.apify.com/integrations/hubspot.md
parents:
...
previous: [Google Drive](https://docs.apify.com/integrations/drive.md)
next: [Keboola](https://docs.apify.com/integrations/keboola.md)
---
...
2. Select **Install**. This starts a two-step OAuth authorization:
...
2. Open any company record.
3. Select the **Customize** button on the right side of the record page.
4. Select the **Default view**.
5. Select **Add card**, then go to the **Card Library**.
6. Search for **Apify** and select **Add card**.
...
![Configuration wizard - Step 1 showing the enrichment details form with name, leads count, department, deduplication dropdown, and apply rules radio buttons](/assets/images/hubspot_config_wizard_step_1-e68daf918cfb7f3525054700a52a3c17.webp)
...
![Configuration wizard - Step 2 showing the field mappings table with source field dropdowns, target field dropdowns, and overwrite/skip selectors](/assets/images/hubspot_config_wizard_step_2-7a333967280d19cdccd541b6c4f5daeb.webp)
...
![Active enrichments list view showing multiple enrichment configs with status badges and action buttons](/assets/images/hubspot_active_enrichments_list-cc0910730c393223a55e303edbe71f89.webp)
...
![Run history view with expanded row showing per-company breakdown, field mappings used, and companies in run](/assets/images/hubspot_per_company_result-2d52b74bdc992f65917c61da17c729a2.webp)
...
![Website URL field highlighted in a HubSpot company record](/assets/images/hubspot_website_url-4a2a570486f54ca2e22b8d56680acf41.webp)
...
* If you are building custom workflows, see how to [integrate Actors via API](https://docs.apify.com/integrations/actors/integrating-actors-via-api.md).
