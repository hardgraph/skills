...
### [1.7.1](https://github.com/apify/apify-cli/releases/tag/v1.7.1) (2026-07-09)[](#171-2026-07-09)
...
### [1.7.0](https://github.com/apify/apify-cli/releases/tag/v1.7.0) (2026-07-02)[](#170-2026-07-02)
...
### [1.6.2](https://github.com/apify/apify-cli/releases/tag/v1.6.2) (2026-06-03)[](#162-2026-06-03)
...
* Enrich cli\_command\_push telemetry with actorId and wasCreated ([#1152](https://github.com/apify/apify-cli/pull/1152)) ([a3931bf](https://github.com/apify/apify-cli/commit/a3931bf6fa840bff115955dddbccb9a949233c70)) by [@patrikbraborec](https://github.com/patrikbraborec), closes [#1151](https://github.com/apify/apify-cli/issues/1151)
...
### [1.6.1](https://github.com/apify/apify-cli/releases/tag/v1.6.1) (2026-05-06)[](#161-2026-05-06)
...
### [1.6.0](https://github.com/apify/apify-cli/releases/tag/v1.6.0) (2026-05-05)[](#160-2026-05-05)
...
### [1.5.0](https://github.com/apify/apify-cli/releases/tag/v1.5.0) (2026-04-27)[](#150-2026-04-27)
...
### [1.4.1](https://github.com/apify/apify-cli/releases/tag/v1.4.1) (2026-04-02)[](#141-2026-04-02)
...
### [1.4.0](https://github.com/apify/apify-cli/releases/tag/v1.4.0) (2026-03-26)[](#140-2026-03-26)
...
### [1.3.0](https://github.com/apify/apify-cli/releases/tag/v1.3.0) (2026-03-11)[](#130-2026-03-11)
...
* Add secrets
  ...
  :ls
  <!-- -->
  command to list all secrets ([#990](https://github.com/apify/apify-cli/pull/990)) ([8256cf5](https://github.com/apify/apify-cli/commit/8256cf55995060c8ff845dede46fb1943c9ec179)) by [@janbuchar](https://github.com/janbuchar), closes [#80](https://github.com/apify/apify-cli/issues/80)
...
### [1.2.1](https://github.com/apify/apify-cli/releases/tag/v1.2.1) (2026-01-06)[](#121-2026-01-06)
...
### [1.2.0](https://github.com/apify/apify-cli/releases/tag/v1.2.0) (2026-01-06)[](#120-2026-01-06)
...
* \[**breaking**] Move from yargs to node
  ...
  :util
  <!-- -->
  ([#871](https://github.com/apify/apify-cli/pull/871)) ([482d0b2](https://github.com/apify/apify-cli/commit/482d0b29f285c020320f1f2e3f0fd08a362d57cc)) by [@vladfrangu](https://github.com/vladfrangu), closes [#833](https://github.com/apify/apify-cli/issues/833)
...
### [0.21.9](https://github.com/apify/apify-cli/releases/tag/v0.21.9) (2025-07-17)[](#0219-2025-07-17)
...
### [0.21.8](https://github.com/apify/apify-cli/releases/tag/v0.21.8) (2025-06-24)[](#0218-2025-06-24)
...
### [0.21.7](https://github.com/apify/apify-cli/releases/tag/v0.21.7) (2025-05-15)[](#0217-2025-05-15)
...
### [0.21.6](https://github.com/apify/apify-cli/releases/tag/v0.21.6) (2025-04-24)[](#0216-2025-04-24)
...
### [0.21.5](https://github.com/apify/apify-cli/releases/tag/v0.21.5) (2025-04-23)[](#0215-2025-04-23)
...
### [0.21.4](https://github.com/apify/apify-cli/releases/tag/v0.21.4) (2025-04-22)[](#0214-2025-04-22)
...
### [0.21.3](https://github.com/apify/apify-cli/releases/tag/v0.21.3) (2025-03-31)[](#0213-2025-03-31)
...
### [0.21.2](https://github.com/apify/apify-cli/releases/tag/v0.21.2) (2025-02-26)[](#0212-2025-02-26)
...
### [0.21.1](https://github.com/apify/apify-cli/releases/tag/v0.21.1) (2025-02-05)[](#0211-2025-02-05)
...
### [0.21.0](https://github.com/apify/apify-cli/releases/tag/v0.21.0) (2025-01-16)[](#0210-2025-01-16)
...
### [0.21.0](https://github.com/apify/apify-cli/releases/tag/v0.21.0) (2025-01-16)[](#0210-2025-01-16-1)
...
## 0.6.1 / 2020-05-18[](#061--2020-05-18)

* **BREAKING:** Templates are now fully decoupled from this project and the [templates repository](https://github.com/apify/actor-templates) serves as the single source of truth. Some templates were replaced and others were renamed to better clarify their purpose.

* **BREAKING:** Providing an invalid template in `apify.json` no longer throws, but rather silently uses a reasonable default configuration. This is to support regular changes to templates without breaking older versions of the CLI.

  ## 0.5.3 / 2020-03-03[](#053--2020-03-03)

* Moved templates to separate repository

* Fixed: creating `apify_storage` in root folder after `apify create` command

  ## 0.5.2 / 2020-01-22[](#052--2020-01-22)
...
* Updated npm packages and fixed all npm audit issues
  ...
  ## 0.5.1 / 2019-12-19[](#051--2019-12-19)
...
* `apify run -p` runs actor, if apify\_storage doesn't exist

* Updated packages

* Additional minor fixes

  ## 0.3.11 / 2019-07-26[](#0311--2019-07-26)
...
* Updated Apify package version in all templates
  ...
  ## 0.3.10 / 2019-06-03[](#0310--2019-06-03)

* Updated packages

  ## 0.3.9 / 2019-05-15[](#039--2019-05-15)

* Improved the templates and texts

  ## 0.3.8 / 2019-03-29[](#038--2019-03-29)

* Updated all templates regarding the last version of apify SDK.

  ## 0.3.7 / 2019-03-18[](#037--2019-03-18)
...
* Fixed templates to use apify/actor-node-chrome Docker image instead of outdated apify/actor-node-puppeteer
  ...
  ## 0.2.3 / 2018-09-17[](#023--2018-09-17)

* Updated all templates to apify version 0.8.\*

* Added template named hello\_word

  ## 0.2.1 / 2018-09-17[](#021--2018-09-17)

* **BREAKING CHANGES**: The local storage directories have been renamed and package.json files needs a new `start` command. See [migration guide](https://github.com/apify/apify-cli/blob/master/MIGRATIONS.md) for existing projects if you are upgrading from 0.1.\_ to 0.2.\_.

* You can specified another file that main.js for `apify run` command using npm start script.

  ## 0.2.0 / 2018-09-12[](#020--2018-09-12)
...
* Fixes #26, #33, #34, #36, #38, #39, #37, #35
  ...
  ## 0.1.11 / 2018-05-30[](#0111--2018-05-30)
...
* Fix #30
  ...
  ## 0.1.9 / 2018-04-18[](#019--2018-04-18)

* apify run takes APIFY\_USER\_ID and APIFY\_TOKEN as environments variables, if client is logged locally

* apify call takes input from default local key-value-store

* Fix: duplicates new lines in log

  ## 0.1.8 / 2018-04-17[](#018--2018-04-17)
...
* apify run - kills all sub processes for SIGINT signal (ctrl+c) - It kills all related browsers in apify run command, related issue: <https://github.com/apify/apify-js/issues/72>
  ...
  ## 0.1.7 / 2018-04-12[](#017--2018-04-12)

* Readme and templates updates

  ## 0.1.6 / 2018-04-11[](#016--2018-04-11)

* Add support for request queue

  ## 0.1.5 / 2018-04-09[](#015--2018-04-09)

* Works for windows

* New command apify info

  ## 0.1.x / 2018-04-01[](#01x--2018-04-01)

* The first public release

  ## 0.0.x / 2018-03-01[](#00x--2018-03-01)
