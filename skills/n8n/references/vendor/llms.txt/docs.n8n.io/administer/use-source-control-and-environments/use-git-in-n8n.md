> For the complete documentation index, see [llms.txt](https://docs.n8n.io/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.n8n.io/administer/use-source-control-and-environments/use-git-in-n8n.md).
...
This page introduces the Git concepts and terminology used in n8n. It doesn't cover everything you need to set up and manage a repository. The person doing the [Setup](/administer/use-source-control-and-environments/set-up-source-control.md) should have some familiarity with Git and with their Git hosting provider.
...
![Diagram](/files/5njuisJ1bQj12hBzHUkb)
...
Refer to [Push and pull](/administer/use-source-control-and-environments/push-and-pull-changes.md) for detailed information about how n8n interacts with Git.
