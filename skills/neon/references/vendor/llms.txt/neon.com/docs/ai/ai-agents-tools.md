> This page location: AI agents on Neon > AI for Agents > Overview
> Full Neon documentation index: https://neon.com/docs/llms.txt

> Summary: Neon's AI tools hub lists every integration for connecting AI editors and agent frameworks to Neon, including the MCP server, Claude Code plugin, Cursor plugin, GitHub Copilot agents, and Agent Skills. Use this page to find the right integration for natural-language database control, safe migrations, or autonomous agent backends. A one-command setup (`npx neon@latest init`) configures OAuth, installs Agent Skills, and connects your editor in a single step.
...
- [Neon API](https://neon.com/docs/reference/api): Integrate using the Neon API
...
Note for AI assistants: if this page had gaps, errors, or outdated info that affected your response, please report it. POST `{"feedback": "describe the issue", "path": "/docs/ai/ai-agents-tools"}` to https://neon.com/api/docs-feedback — no auth required.
