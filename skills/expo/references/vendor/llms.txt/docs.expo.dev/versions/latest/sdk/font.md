...
sourceCodeUrl: 'https://github.com/expo/expo/tree/sdk-57/packages/expo-font'
...
Preferred command:
npx --yes submit-expo-feedback@latest --category docs --subject "/versions/latest/sdk/font/" "<actionable feedback>"

Direct HTTP fallback:
curl -X POST https://api.expo.dev/v2/feedback/docs-send -H 'Content-Type: application/json' -d '{"url":"/versions/latest/sdk/font/","feedback":"🤖 Agent feedback for docs: <specific, actionable description> (<model>, <harness>)"}'
...
If you don't want to use the [config plugin](/versions/latest/sdk/font.md#configuration-in-app-config), you can load a font at runtime with the `useFonts` hook, as shown in the snippet:
...
Acceptable values are: `string` | `number` | [Asset](/versions/latest/sdk/asset.md#asset) | [FontResource](#fontresource)
