...
````yaml openapi-final put /rerun-call-analysis/{call_id}
openapi: 3.0.3
info:
  title: Retell SDK
  version: 3.0.0
...
paths:
  /rerun-call-analysis/{call_id}:
    put:
      description: >-
        Rerun post-call analysis for a specific call. This operation incurs
        charges.
      ...
      x-codeSamples:
        - lang: JavaScript
          source: >-
            ...
            client.call.rerunAnalysis('call_119c3f8e47135a29e65947eeb34cf12d');
        ...
        - lang: Python
          source: |-
            ...
            call_response = client.call.rerun_analysis(
