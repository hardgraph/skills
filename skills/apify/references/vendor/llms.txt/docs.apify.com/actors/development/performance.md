---
title: Performance
url: https://docs.apify.com/actors/development/performance.md
parents:
  - [Apify documentation](https://docs.apify.com/llms.txt)
  - [Actors](https://docs.apify.com/actors.md)
  - [Development](https://docs.apify.com/actors/development.md)
previous: [Automated tests](https://docs.apify.com/actors/development/automated-tests.md)
next: [Publishing and monetization](https://docs.apify.com/actors/publishing.md)
---
