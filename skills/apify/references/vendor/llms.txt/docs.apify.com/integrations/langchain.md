...
url: https://docs.apify.com/integrations/langchain.md
parents:
  - [Apify documentation](https://docs.apify.com/llms.txt)
  - [Integrations](https://docs.apify.com/integrations.md)
  - [AI](https://docs.apify.com/integrations/ai.md)
previous: [Haystack](https://docs.apify.com/integrations/haystack.md)
next: [Langflow](https://docs.apify.com/integrations/langflow.md)
---
...
This example demonstrates how to integrate Apify with LangChain using the Python language. If you prefer to use JavaScript, you can follow the [JavaScript LangChain documentation](https://docs.langchain.com/oss/javascript/integrations/document_loaders/web_loaders/apify_dataset).
