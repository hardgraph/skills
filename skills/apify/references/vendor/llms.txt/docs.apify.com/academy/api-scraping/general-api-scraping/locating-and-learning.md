...
url: https://docs.apify.com/academy/api-scraping/general-api-scraping/locating-and-learning.md
parents:
...
previous: [General API scraping](https://docs.apify.com/academy/api-scraping/general-api-scraping.md)
next: [Dealing with headers, cookies, and tokens](https://docs.apify.com/academy/api-scraping/general-api-scraping/cookies-headers-tokens.md)
---
