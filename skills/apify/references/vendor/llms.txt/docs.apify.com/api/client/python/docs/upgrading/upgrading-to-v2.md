...
* The deprecated parameters `as_bytes` and `as_file` have been removed from [`KeyValueStoreClient.get_record()`](https://docs.apify.com/api/client/python/api/client/python/reference/class/KeyValueStoreClient.md#get_record). Use the dedicated methods [`get_record_as_bytes()`](https://docs.apify.com/api/client/python/api/client/python/reference/class/KeyValueStoreClient.md#get_record_as_bytes) and [`stream_record()`](https://docs.apify.com/api/client/python/api/client/python/reference/class/KeyValueStoreClient.md#stream_record) instead.
...
* Error classes are now accessible from the public `apify_client.errors` module. See the [`ApifyApiError`](https://docs.apify.com/api/client/python/api/client/python/reference/class/ApifyApiError.md) API reference for a complete list of available error classes.
