...
url: https://docs.apify.com/actors/publishing/monetize/pay-per-event.md
parents:
  - [Apify documentation](https://docs.apify.com/llms.txt)
  - [Actors](https://docs.apify.com/actors.md)
  - [Publishing and monetization](https://docs.apify.com/actors/publishing.md)
  - [Monetize your Actor](https://docs.apify.com/actors/publishing/monetize.md)
previous: [Manage payouts](https://docs.apify.com/actors/publishing/monetize/monthly-payouts.md)
next: [Rental pricing model](https://docs.apify.com/actors/publishing/monetize/rental.md)
---
...
You define the events and can set different pricing for each event type and [discount tier](https://docs.apify.com/actors/publishing/monetize/pricing-and-costs.md#discount-tiers).

### Synthetic events

Synthetic events are predefined by Apify and charged automatically:

* apify-actor-start reduces the costs of starting the Actor.
* apify-default-dataset-item charges for each item written to the default dataset of the run.
...
To retrieve the list of all chargeable event names for your Actor, use the [Get Actor](https://docs.apify.com/api/v2/actor-get.md) API endpoint.
...
* `platform costs` are the underlying platform usage costs for running the Actor. For details, see [Compute costs for PPE Actors](https://docs.apify.com/actors/publishing/monetize/pricing-and-costs.md#compute-costs).
...
To make your Actor profitable, price your events so that the revenue covers the platform costs. For details, see [Compute costs for PPE Actors](https://docs.apify.com/actors/publishing/monetize/pricing-and-costs.md#compute-costs).

If your Actor produces negative profit, make sure to:

* Set memory limits.
* Respect user spending limits.
* Enable the apify-actor-start synthetic event.
...
Charging platform usage separately is less transparent for users and may discourage them from using your Actor. It also negatively impacts your [Actor quality score](https://docs.apify.com/actors/publishing/quality-score.md). Use this approach only until you determine accurate event prices.

To pass platform usage costs on to users:

1. Go to the **Actor pricing** step of the [monetization setup](https://docs.apify.com/actors/publishing/monetize.md#set-up-monetization).
...
To simplify PPE implementation into you Actor, use the [Apify SDKs](https://docs.apify.com/sdk.md). They help you handle pricing, usage tracking, idempotency keys, API errors, and event charging through an API. Without the SDKs, you must handle API integration and possible edge cases manually.

To implement event charging with the Apify CLI, use the [apify actor charge](https://docs.apify.com/cli/docs/reference#apify-actor-charge) command.

You can also call the [Charge events in run](https://docs.apify.com/api/v2/post-charge-run.md) API endpoint directly.
...
To prevent users from setting the maximum cost for the run too low, set the minimum value during the [monetization setup](https://docs.apify.com/actors/publishing/monetize.md#set-up-monetization). For example, you can use it to cover the price of starting the Actor and producing one result.

The minimum value is stored by the `minimalMaxTotalChargeUsd` property.

The user spending limit is available in your Actor code as the `ACTOR_MAX_TOTAL_CHARGE_USD` [environment variable](https://docs.apify.com/actors/development/programming-interface/environment-variables.md), and `ChargeResult` already accounts for it. Returning a `ChargeResult` depends on the event type:
...
1. Access your Actor's [monetization setup](https://docs.apify.com/actors/publishing/monetize.md#set-up-monetization).
...
The platform usage costs are just examples, but you can see the actual costs in the [Computing your costs for PPE Actors](https://docs.apify.com/actors/publishing/monetize/pricing-and-costs.md#computing-your-costs-for-ppe-actors) section.
...
* Check out the [Pricing and costs](https://docs.apify.com/actors/publishing/monetize/pricing-and-costs.md) section to learn how to compute your costs.
