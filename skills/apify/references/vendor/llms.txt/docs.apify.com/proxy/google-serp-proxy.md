...
url: https://docs.apify.com/proxy/google-serp-proxy.md
parents:
  - [Apify documentation](https://docs.apify.com/llms.txt)
  - [Proxy](https://docs.apify.com/proxy.md)
previous: [Residential proxy](https://docs.apify.com/proxy/residential-proxy.md)
...
The `username` field enables you to pass various [parameters](https://docs.apify.com/proxy.md#username-parameters), such as groups and country, for your proxy connection.
...
Unlike [datacenter](https://docs.apify.com/proxy/datacenter-proxy.md) or [residential](https://docs.apify.com/proxy/residential-proxy.md) proxies, there is no [session](https://docs.apify.com/proxy.md#sessions) parameter.

If you use the `country` [parameter](https://docs.apify.com/proxy.md), the Google proxy location is used if you access a website whose hostname (stripped of `www.`) starts with **google**.
...
By default, Google returns up to *10 search results per page*. To retrieve additional results beyond the first page, use the `numPages` query parameter.
...
Pricing for multi-page requests
...
If you are developing your own Apify [Actor](https://docs.apify.com/actors.md) using the [Apify SDK](https://docs.apify.com/sdk.md) and [Crawlee](https://crawlee.dev/), the most efficient way to use Google SERP proxy is [CheerioCrawler](https://crawlee.dev/api/cheerio-crawler/class/CheerioCrawler). This is because Google SERP proxy [only returns a page's HTML](https://docs.apify.com/proxy.md). Alternatively, you can use the [got-scraping](https://github.com/apify/got-scraping) [npm package](https://www.npmjs.com/package/got-scraping) by specifying the proxy URL in the options. For Python, you can leverage the [requests](https://pypi.org/project/requests/) library along with the Apify SDK.
