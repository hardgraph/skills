> This page location: Postgres > Extensions > AI & Search > AI App Starter Kit > Optimize & scale > Scale with Neon
...
On the Free plan, you get 0.5 GB of storage per project. Storage on paid plans is usage based. See [Neon plans](https://neon.com/docs/introduction/plans) for details.
...
- [Optimize vector search](https://neon.com/docs/ai/ai-vector-search-optimization)
