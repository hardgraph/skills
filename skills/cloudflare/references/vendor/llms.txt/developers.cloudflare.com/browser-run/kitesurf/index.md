...
Kitesurf is in beta and available for free, behind per-account [limits](https://developers.cloudflare.com/browser-run/limits/).
...
You can also use Kitesurf with Browser Run's [Quick Actions](https://developers.cloudflare.com/browser-run/quick-actions/). Add `browser=kitesurf` to any Quick Action endpoint.
...
Any AI agent that speaks MCP and CDP can use Kitesurf. Add the following to your [MCP client](https://developers.cloudflare.com/browser-run/cdp/mcp-clients/) configuration:
