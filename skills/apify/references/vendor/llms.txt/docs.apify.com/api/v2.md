...
children:
  - [Get started](https://docs.apify.com/api/v2/getting-started.md)
  - [Actors](https://docs.apify.com/api/v2/actors.md)
  - [Actor versions](https://docs.apify.com/api/v2/actors-actor-versions.md)
  - [Actor builds](https://docs.apify.com/api/v2/actors-actor-builds.md)
  - [Actor runs](https://docs.apify.com/api/v2/actors-actor-runs.md)
  - [Webhook collections](https://docs.apify.com/api/v2/actors-webhook-collection.md)
  - [Manage Actor builds](https://docs.apify.com/api/v2/actor-builds.md)
  - [Manage Actor runs](https://docs.apify.com/api/v2/actor-runs.md)
  - [Manage Actor tasks](https://docs.apify.com/api/v2/actor-tasks.md)
  - [Datasets](https://docs.apify.com/api/v2/storage-datasets.md)
  - [Key-value stores](https://docs.apify.com/api/v2/storage-key-value-stores.md)
  - [Request queues](https://docs.apify.com/api/v2/storage-request-queues.md)
  - [Requests](https://docs.apify.com/api/v2/storage-request-queues-requests.md)
  - [Requests locks](https://docs.apify.com/api/v2/storage-request-queues-requests-locks.md)
  - [Webhooks](https://docs.apify.com/api/v2/webhooks-webhooks.md)
  - [Webhook dispatches](https://docs.apify.com/api/v2/webhooks-webhook-dispatches.md)
  - [Manage schedules](https://docs.apify.com/api/v2/schedules.md)
  - [Get data from Apify Store](https://docs.apify.com/api/v2/store.md)
  - [Get build and run logs](https://docs.apify.com/api/v2/logs.md)
  - [Get user data](https://docs.apify.com/api/v2/users.md)
  - [Manage usage and limits](https://docs.apify.com/api/v2/users-usage.md)
  - [Test proxy](https://docs.apify.com/api/v2/tools.md)
  - [Sign and verify objects](https://docs.apify.com/api/v2/tools-encoding.md)
  - [Default dataset](https://docs.apify.com/api/v2/default-dataset.md)
  - [Default key-value store](https://docs.apify.com/api/v2/default-key-value-store.md)
  - [Default request queue](https://docs.apify.com/api/v2/default-request-queue.md)
  - [Last Actor run's default dataset](https://docs.apify.com/api/v2/last-actor-runs-default-dataset.md)
  - [Last Actor run's default key-value store](https://docs.apify.com/api/v2/last-actor-runs-default-key-value-store.md)
  - [Last Actor run's default request queue](https://docs.apify.com/api/v2/last-actor-runs-default-request-queue.md)
  - [Last Actor run's log](https://docs.apify.com/api/v2/last-actor-runs-log.md)
  - [Last Actor run's abort](https://docs.apify.com/api/v2/last-actor-runs-abort.md)
  - [Last Actor run's metamorph](https://docs.apify.com/api/v2/last-actor-runs-metamorph.md)
  - [Last Actor run's reboot](https://docs.apify.com/api/v2/last-actor-runs-reboot.md)
  - [Last Actor task run's log](https://docs.apify.com/api/v2/last-actor-task-runs-log.md)
  - [Last Actor task run's abort](https://docs.apify.com/api/v2/last-actor-task-runs-abort.md)
  - [Last Actor task run's metamorph](https://docs.apify.com/api/v2/last-actor-task-runs-metamorph.md)
  - [Last Actor task run's reboot](https://docs.apify.com/api/v2/last-actor-task-runs-reboot.md)
  - [Last Actor task run's default dataset](https://docs.apify.com/api/v2/last-actor-task-runs-default-dataset.md)
  - [Last Actor task run's default key-value store](https://docs.apify.com/api/v2/last-actor-task-runs-default-key-value-store.md)
  - [Last Actor task run's default request queue](https://docs.apify.com/api/v2/last-actor-task-runs-default-request-queue.md)
next: [Get started](https://docs.apify.com/api/v2/getting-started.md)
---
...
* For [Node.js](https://nodejs.org/en/), we recommend the [apify-client](https://docs.apify.com/api/client/js) [NPM package](https://www.npmjs.com/package/apify-client).
* For [Python](https://www.python.org/), we recommend the [apify-client](https://docs.apify.com/api/client/python) [PyPI package](https://pypi.org/project/apify-client/).
...
**You can find your API token on the [Integrations](https://console.apify.com/settings/integrations) page in the Apify Console.**
...
The `/v2/acts/` prefix is deprecated but still fully functional, and such endpoint routes to the same handler as its `/v2/actors/...` counterpart. New integrations should use the canonical /v2/actors/ prefix, but existing clients keep working without changes.
...
The records in the [key-value store](https://docs.apify.com/platform/storage/key-value-store) are not ordered based on numerical indexes, but rather by their keys in the UTF-8 binary order. Therefore the Get list of keys API endpoint only supports pagination using the following query parameters:
