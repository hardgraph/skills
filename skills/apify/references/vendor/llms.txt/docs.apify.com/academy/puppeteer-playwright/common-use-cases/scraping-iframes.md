...
url: https://docs.apify.com/academy/puppeteer-playwright/common-use-cases/scraping-iframes.md
parents:
...
previous: [Submitting a form with a file attachment](https://docs.apify.com/academy/puppeteer-playwright/common-use-cases/submitting-a-form-with-a-file-attachment.md)
next: [API scraping](https://docs.apify.com/academy/api-scraping.md)
---
