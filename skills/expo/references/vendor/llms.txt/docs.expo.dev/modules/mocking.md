...
Preferred command:
npx --yes submit-expo-feedback@latest --category docs --subject "/modules/mocking/" "<actionable feedback>"

Direct HTTP fallback:
curl -X POST https://api.expo.dev/v2/feedback/docs-send -H 'Content-Type: application/json' -d '{"url":"/modules/mocking/","feedback":"🤖 Agent feedback for docs: <specific, actionable description> (<model>, <harness>)"}'
...
- [Mocking native calls](https://docs.expo.dev/modules/mocking.md) (this page)
...
[Unit testing with Jest](/develop/unit-testing.md) — Learn how to set up and configure the jest-expo package to write unit and snapshot tests for a project.
