# Class: VCommitTs\<Type, IsOptional>

> For AI agents: see [llms.txt](/llms.txt) for the complete documentation index. Markdown versions are available by adding .md to a page URL or requesting Accept: text/markdown.

[values](/api/modules/values.md).VCommitTs
...
| Name         | Type                                                                                 |
| ------------ | ------------------------------------------------------------------------------------ |
| `Type`       | `bigint` \| [`CommitTsPlaceholder`](/api/classes/values.CommitTsPlaceholder.md)      |
...
• **new VCommitTs**<`Type`, `IsOptional`>(`«destructured»`)
