...
Preferred command:
npx --yes submit-expo-feedback@latest --category docs --subject "/guides/keyboard-handling/" "<actionable feedback>"

Direct HTTP fallback:
curl -X POST https://api.expo.dev/v2/feedback/docs-send -H 'Content-Type: application/json' -d '{"url":"/guides/keyboard-handling/","feedback":"🤖 Agent feedback for docs: <specific, actionable description> (<model>, <harness>)"}'
...
- [Keyboard handling](https://docs.expo.dev/guides/keyboard-handling.md) (this page)
...
The Keyboard Controller library is not included in Expo Go. See [Create a development build](/develop/development-builds/introduction.md#how-would-you-like-to-build-your-development-build) for more information.

##### react-native-reanimated installed

Keyboard Controller requires `react-native-reanimated` to work correctly. Follow the [installation instructions](/versions/latest/sdk/reanimated.md#installation).
...
The [`KeyboardAvoidingView`](/guides/keyboard-handling.md#keyboard-avoiding-view) component is excellent for prototyping, but it requires platform-specific configuration and is not very customizable.
