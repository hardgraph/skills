...
Preferred command:
npx --yes submit-expo-feedback@latest --category docs --subject "/router/basics/navigation/" "<actionable feedback>"

Direct HTTP fallback:
curl -X POST https://api.expo.dev/v2/feedback/docs-send -H 'Content-Type: application/json' -d '{"url":"/router/basics/navigation/","feedback":"🤖 Agent feedback for docs: <specific, actionable description> (<model>, <harness>)"}'
...
- [Navigation](https://docs.expo.dev/router/basics/navigation.md) (this page)
...
[Router imperative navigation API reference](/versions/latest/sdk/router.md#imperativerouter) — Learn how to use all the functions available for imperative navigation.
...
[Link API reference](/versions/latest/sdk/router/link.md#link) — Learn the options available when using Links for navigation.

[Link preview](/router/reference/link-preview.md) — Learn how to add a preview to your link on iOS when using Expo Router.
...
> Some parameters are reserved for internal use by Expo Router and React Navigation. You can find them in the [Using URL parameters guide](/router/reference/url-parameters.md#reserved-parameters).
...
[Using URL parameters](/router/reference/url-parameters.md) — Learn more about how to set and use URL parameters in Expo Router.
...
On web, deep linking is as simple as navigating to that specific URL in your web browser. On mobile, you define a `scheme` in your [app config](/workflow/configuration.md) file, and this becomes the prefix for deep links into your app.
...
With app links and universal links, you can also link to your app with an `https` URL. For more information, see [Universal linking](/linking/overview.md#universal-linking).
