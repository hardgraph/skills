...
url: https://docs.apify.com/academy/api-scraping/graphql-scraping/custom-queries.md
parents:
...
previous: [Introspection](https://docs.apify.com/academy/api-scraping/graphql-scraping/introspection.md)
next: [Anti-scraping protections](https://docs.apify.com/academy/anti-scraping.md)
---
