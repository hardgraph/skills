---
title: Get started with Apify API
url: https://docs.apify.com/api/v2/getting-started.md
parents:
  - [Apify documentation](https://docs.apify.com/llms.txt)
  - [Apify API documentation](https://docs.apify.com/api.md)
  - [Apify API](https://docs.apify.com/api/v2.md)
previous: [Apify API](https://docs.apify.com/api/v2.md)
next: [Actors](https://docs.apify.com/api/v2/actors.md)
---
...
```http
POST https://api.apify.com/v2/actors/:actorId/run-sync
```
