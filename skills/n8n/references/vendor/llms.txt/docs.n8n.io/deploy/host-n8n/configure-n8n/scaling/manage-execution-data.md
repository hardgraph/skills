> For the complete documentation index, see [llms.txt](https://docs.n8n.io/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.n8n.io/deploy/host-n8n/configure-n8n/scaling/manage-execution-data.md).
...
To do this, configure the corresponding [environment variables](/deploy/host-n8n/configure-n8n/basic-configuration/use-environment-variables/executions.md).
...
You can also configure these settings on an individual workflow basis using the [workflow settings](/build/manage-workflows/configure-workflow-settings.md).
{% endhint %}
