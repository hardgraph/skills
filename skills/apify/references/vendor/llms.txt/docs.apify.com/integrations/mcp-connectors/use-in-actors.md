...
url: https://docs.apify.com/integrations/mcp-connectors/use-in-actors.md
parents:
...
previous: [MCP connectors](https://docs.apify.com/integrations/mcp-connectors.md)
next: [MCP server](https://docs.apify.com/integrations/mcp.md)
---
...
# Build Actors with MCP connectors

This guide explains how to build Actors that accept [MCP connectors](https://docs.apify.com/integrations/mcp-connectors.md) as input, connect to them at runtime, and constrain which tools they can call.
...
* *Eligibility filter* - the connector picker in the input form only offers connectors that match at least one rule.
* *Runtime ceiling* - the proxy holds the Actor to its declaration. The Actor can only see (through a filtered `tools/list`) and call (through a guarded `tools/call`) tools that fall within the rule it matched.
...
For the full schema, see The mcpServers rule list.

## Related pages

* [MCP connectors overview](https://docs.apify.com/integrations/mcp-connectors.md)
* [Input schema specification - resource type](https://docs.apify.com/actors/development/actor-definition/input-schema/specification/v1.md#resource-type)
* [Account settings - MCP connectors](https://docs.apify.com/account/settings.md#mcp-connectors)
* [Apify environment variables](https://docs.apify.com/actors/development/programming-interface/environment-variables.md#system-environment-variables)
