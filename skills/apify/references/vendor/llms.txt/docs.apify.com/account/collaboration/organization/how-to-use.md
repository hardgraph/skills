...
url: https://docs.apify.com/account/collaboration/organization/how-to-use.md
parents:
...
previous: [Setup](https://docs.apify.com/account/collaboration/organization/setup.md)
next: [List of permissions](https://docs.apify.com/account/collaboration/list-of-permissions.md)
---
...
While you can't manage an organization account via [API](https://docs.apify.com/api/v2.md), you can still manage its runs and resources via API like you would with any other account.
...
![Switch to organization account](/assets/images/switch-to-organization-07e45e752de19960be1e4e7d3c50336a.png)
...
The resources you can access and account details you can edit will depend on your [permissions](https://docs.apify.com/account/collaboration/list-of-permissions.md) in the organization.
...
![My organizations](/assets/images/my-organizations-7bce1547f43ea18b2697e194e9a4afdc.png)
...
As a member of an organization, you are assigned an [API token](https://docs.apify.com/integrations.md) (under the **API & Integrations** tab) and proxy password (click the **Proxy** button in the left menu) for accessing the Apify platform via REST API.

![Integration tokens](/assets/images/integrations-3bcfb69a99ba013b4e4c4e9d50e252ba.png)
...
For a [detailed breakdown of all Apify API endpoints](https://docs.apify.com/api/v2.md) and help on using them, visit the API.
