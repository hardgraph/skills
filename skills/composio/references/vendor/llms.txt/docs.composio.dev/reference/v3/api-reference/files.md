...
> **API version:** This page documents Composio REST API v3.0 at `https://backend.composio.dev/api/v3`, the previous version. v3.1 is current, at `https://backend.composio.dev/api/v3.1` — the same page on v3.1 is /reference/api-reference/files.md.
...
| --- | --- | --- |
| `GET` | `/api/v3/files/list` | [List files with optional app and action filters (DEPRECATED) (Legacy)](/reference/v3/api-reference/files/getFilesList) |
| `POST` | `/api/v3/files/upload/request` | [Create presigned URL for request file upload to S3](/reference/v3/api-reference/files/postFilesUploadRequest) |
