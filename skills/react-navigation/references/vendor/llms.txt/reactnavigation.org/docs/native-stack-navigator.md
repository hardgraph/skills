...
To get the height of the header, you can use [`HeaderHeightContext`](elements.md#headerheightcontext) with [React's Context API](https://react.dev/reference/react/createContext#consumer) or [`useHeaderHeight`](elements.md#useheaderheight).
