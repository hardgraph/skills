...
A team access token can only perform actions you have access to on the team. If you have [custom roles](/team-management/role-actions.md), the token can only perform the actions allowed by your roles.
...
[Management API Reference](/management-api/overview.md)
...
To view the full list of commands, refer to the [CLI documentation](/cli/overview.md).
