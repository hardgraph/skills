...
url: https://docs.apify.com/actors/publishing/actor-status.md
parents:
  - [Apify documentation](https://docs.apify.com/llms.txt)
  - [Actors](https://docs.apify.com/actors.md)
  - [Publishing and monetization](https://docs.apify.com/actors/publishing.md)
previous: [Monitor your Actor's rating](https://docs.apify.com/actors/publishing/actor-rating.md)
---
...
Note that the **Under maintenance** status makes your Actor rank lower in search results. It's also automatically set when your Actor fails the [automated testing](https://docs.apify.com/actors/development/automated-tests.md) process.
...
Note that the deprecated Actors aren't searchable in Apify Store. The **Deprecated** status is also automatically set when your Actor fails the [automated testing](https://docs.apify.com/actors/development/automated-tests.md) process for 30 days.
