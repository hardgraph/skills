...
Preferred command:
npx --yes submit-expo-feedback@latest --category docs --subject "/guides/sdk-libraries-migration/contacts/" "<actionable feedback>"

Direct HTTP fallback:
curl -X POST https://api.expo.dev/v2/feedback/docs-send -H 'Content-Type: application/json' -d '{"url":"/guides/sdk-libraries-migration/contacts/","feedback":"🤖 Agent feedback for docs: <specific, actionable description> (<model>, <harness>)"}'
...
- [expo-contacts/legacy](https://docs.expo.dev/guides/sdk-libraries-migration/contacts.md) (this page)
...
[Contacts](/versions/latest/sdk/contacts.md) — See the full API reference for expo-contacts.
