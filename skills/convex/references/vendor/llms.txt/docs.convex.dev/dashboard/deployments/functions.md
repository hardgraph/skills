...
![Functions Dashboard View](/assets/images/functions-00000000.png)

The [functions page](https://dashboard.convex.dev/deployment/functions) shows all currently deployed Convex functions.

For dev deployments, these are updated continuously by [`npx convex dev`](/cli/reference/dev.md). The functions for production deployments are registered with [`npx convex deploy`](/cli/reference/deploy.md).
...
![Running a function](/assets/images/run_function-00000000.png)
...
![Acting as a user](/assets/images/acting_as_a_user-00000000.png)
...
There are four basic charts for each function. For overall team usage metrics, see [team settings](/dashboard/teams/teams.md#usage).
