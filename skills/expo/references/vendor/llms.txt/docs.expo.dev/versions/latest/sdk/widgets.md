...
Preferred command:
npx --yes submit-expo-feedback@latest --category docs --subject "/versions/latest/sdk/widgets/" "<actionable feedback>"

Direct HTTP fallback:
curl -X POST https://api.expo.dev/v2/feedback/docs-send -H 'Content-Type: application/json' -d '{"url":"/versions/latest/sdk/widgets/","feedback":"🤖 Agent feedback for docs: <specific, actionable description> (<model>, <harness>)"}'
...
[Watch: How to build an iOS widget](https://www.youtube.com/watch?v=3r_OHePTCcI) — Build a native iOS home screen widget in TypeScript with expo-widgets.
...
| `liveActivity` | [LiveActivityComponent](/versions/latest/sdk/widgets.md#liveactivitycomponentprops-environment)<T\> | The Live Activity component, marked with the `'widget'` directive. |
...
| `widget` | (props: PropsType, context: [WidgetEnvironment](#widgetenvironment)<ConfigurationType\>) => [Element](https://www.typescriptlang.org/docs/handbook/jsx.html#function-component) | The widget component, marked with the `'widget'` directive. |
...
| --- | --- |
| `props` | `T` |
| `environment` | [LiveActivityEnvironment](/versions/latest/sdk/widgets.md#liveactivityenvironment) |
