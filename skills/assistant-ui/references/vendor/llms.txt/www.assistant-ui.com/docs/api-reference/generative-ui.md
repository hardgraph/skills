...
- [Slack Block Kit](/docs/api-reference/generative-ui/slack) — Convert generative UI trees to Slack Block Kit payloads and decode block\_actions interactions back into $action payloads.
- [Microsoft Teams](/docs/api-reference/generative-ui/teams) — Convert generative UI trees to Teams Adaptive Cards and decode Action.Submit payloads back into $action payloads.
- [A2UI](/docs/api-reference/generative-ui/a2ui) — Convert A2UI surface operations into generative UI specs.
