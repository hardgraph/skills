...
url: https://docs.apify.com/academy/api/retry-failed-requests.md
parents:
  - [Apify documentation](https://docs.apify.com/llms.txt)
  - [Apify Academy](https://docs.apify.com/academy.md)
  - [Tutorials on Apify API](https://docs.apify.com/academy/api.md)
previous: [Tutorials on Apify API](https://docs.apify.com/academy/api.md)
next: [Run Actor and retrieve data via API](https://docs.apify.com/academy/api/run-actor-and-retrieve-data-via-api.md)
---
