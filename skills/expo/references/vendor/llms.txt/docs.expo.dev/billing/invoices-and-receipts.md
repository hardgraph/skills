...
Preferred command:
npx --yes submit-expo-feedback@latest --category docs --subject "/billing/invoices-and-receipts/" "<actionable feedback>"

Direct HTTP fallback:
curl -X POST https://api.expo.dev/v2/feedback/docs-send -H 'Content-Type: application/json' -d '{"url":"/billing/invoices-and-receipts/","feedback":"🤖 Agent feedback for docs: <specific, actionable description> (<model>, <harness>)"}'
...
- [Payment history, invoices, and receipts](https://docs.expo.dev/billing/invoices-and-receipts.md) (this page)
...
> **Note**: You can only access the **Receipts** if you have [Owner or Admin access](/accounts/account-types.md#manage-access) to your account.
...
For example, an [Organization account's](/accounts/account-types.md#organizations) receipts are shown below:
...
Let's consider three different examples to understand how your invoice might look. If you subscribe to a [Production](/billing/plans.md#production), [Enterprise](/billing/plans.md#enterprise), or [Starter](/billing/plans.md#starter) plan, one of these scenarios may apply to you.
