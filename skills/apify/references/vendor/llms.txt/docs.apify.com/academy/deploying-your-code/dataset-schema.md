...
url: https://docs.apify.com/academy/deploying-your-code/dataset-schema.md
parents:
...
previous: [How to write Actor input schema](https://docs.apify.com/academy/deploying-your-code/input-schema.md)
next: [Creating Actor Dockerfile](https://docs.apify.com/academy/deploying-your-code/docker-file.md)
---
...
Visit the [dataset schema documentation](https://docs.apify.com/storage/dataset-schema.md) for more detailed information about how to implement this feature.
