...
Preferred command:
npx --yes submit-expo-feedback@latest --category docs --subject "/guides/using-feature-flags/" "<actionable feedback>"

Direct HTTP fallback:
curl -X POST https://api.expo.dev/v2/feedback/docs-send -H 'Content-Type: application/json' -d '{"url":"/guides/using-feature-flags/","feedback":"🤖 Agent feedback for docs: <specific, actionable description> (<model>, <harness>)"}'
...
You are here: Guides > Integrations > Feature flags
Pages in this section:
- [Using feature flags](https://docs.expo.dev/guides/using-feature-flags.md) (this page)
...
The following libraries provide robust support for feature flag functionality and out-of-the-box compatibility with Expo apps using [Continuous Native Generation (CNG)](/workflow/continuous-native-generation.md) and [config plugins](/config-plugins/introduction.md) for seamless integration in your app.
