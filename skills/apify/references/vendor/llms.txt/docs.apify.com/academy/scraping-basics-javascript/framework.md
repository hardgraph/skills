...
url: https://docs.apify.com/academy/scraping-basics-javascript/framework.md
parents:
...
previous: [Scraping product variants](https://docs.apify.com/academy/scraping-basics-javascript/scraping-variants.md)
next: [Using a platform](https://docs.apify.com/academy/scraping-basics-javascript/platform.md)
---
...
3. Define an asynchronous function as a default request handler. It receives a context object with Cheerio's `$` instance and a logger.
