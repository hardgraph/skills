...
> Summary: Neon is a complete set of cloud backend primitives built around Lakebase Postgres, for developers, startups, and agent platforms, from Databricks. Lakebase Postgres runs on the lakebase architecture, making instant branching, autoscaling, scale-to-zero, and point-in-time restore intrinsic rather than add-ons. Neon also includes Managed Better Auth, Object Storage, Functions, and AI Gateway.
...
**Tip: Neon, now a part of Databricks**

In May 2025, Neon joined Databricks to shape the future of Postgres and AI-native development. Our mission stayed the same. Lakebase Postgres is also available on Databricks, as [Lakebase](https://www.databricks.com/product/lakebase). Learn more in [Neon and Lakebase](https://neon.com/docs/introduction/neon-and-lakebase).
...
- Neon's straightforward and feature-complete [API](https://neon.com/docs/reference/api)
...
**Tip: Neon and Lakebase**

Lakebase Postgres is available via Neon and via Databricks. For what's the same in both places and when to choose each, see [Neon and Lakebase](https://neon.com/docs/introduction/neon-and-lakebase).

> **Contact us**
>
> Lakebase Postgres via Neon and via Databricks are two access paths to the same database product. Explore your options and get help deciding which fits your workload.
>
