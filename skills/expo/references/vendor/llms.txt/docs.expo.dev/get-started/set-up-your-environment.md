...
Preferred command:
npx --yes submit-expo-feedback@latest --category docs --subject "/get-started/set-up-your-environment/" "<actionable feedback>"

Direct HTTP fallback:
curl -X POST https://api.expo.dev/v2/feedback/docs-send -H 'Content-Type: application/json' -d '{"url":"/get-started/set-up-your-environment/","feedback":"🤖 Agent feedback for docs: <specific, actionable description> (<model>, <harness>)"}'
...
- [Set up your environment](https://docs.expo.dev/get-started/set-up-your-environment.md) (this page)
