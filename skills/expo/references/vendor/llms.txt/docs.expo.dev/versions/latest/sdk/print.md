...
sourceCodeUrl: 'https://github.com/expo/expo/tree/sdk-57/packages/expo-print'
...
Preferred command:
npx --yes submit-expo-feedback@latest --category docs --subject "/versions/latest/sdk/print/" "<actionable feedback>"

Direct HTTP fallback:
curl -X POST https://api.expo.dev/v2/feedback/docs-send -H 'Content-Type: application/json' -d '{"url":"/versions/latest/sdk/print/","feedback":"🤖 Agent feedback for docs: <specific, actionable description> (<model>, <harness>)"}'
...
Prints HTML to PDF file and saves it to [app's cache directory](/versions/latest/sdk/filesystem.md#cache). On Web this method opens the print dialog.
