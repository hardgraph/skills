> For the complete documentation index, see [llms.txt](https://docs.n8n.io/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.n8n.io/contribute/style-guide-for-n8n-docs.md).
...
See the [Terminology and naming](/contribute/terminology.md) word list for the full set of terms to use and avoid.
...
* **Link in the body, at the first meaningful mention**, with descriptive anchor text that names the target: [Configure the Schedule Trigger](https://github.com/n8n-io/n8n-docs/tree/main/docs/contribute/configure-schedule-trigger.md), not "click here". Link the first mention, not every mention.
...
See [Build and manage agents](/build/build-and-manage-agents.md) for a working example.
