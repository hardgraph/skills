...
url: https://docs.apify.com/academy/scraping-basics-python/downloading-html.md
parents:
...
previous: [DevTools: Extracting data](https://docs.apify.com/academy/scraping-basics-python/devtools-extracting-data.md)
next: [Parsing HTML](https://docs.apify.com/academy/scraping-basics-python/parsing-html.md)
---
...
Download a product image, then save it on your disk as a file. While HTML is *textual* content, images are *binary*. You may want to scan through the [HTTPX QuickStart](https://www.python-httpx.org/quickstart/) for guidance. You can use this URL pointing to an image of a TV:
