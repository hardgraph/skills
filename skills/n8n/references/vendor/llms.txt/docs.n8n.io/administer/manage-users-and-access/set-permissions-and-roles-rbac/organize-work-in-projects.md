...
n8n uses projects to group workflows and credentials[^1], and assigns [roles](/administer/manage-users-and-access/set-permissions-and-roles-rbac/see-available-roles.md) to users in each project. This means that a single user can have different roles in different projects, giving them different levels of access.
...
1. Select <img src="/files/6jSPfuNbPKzGmYxQDLYs" alt="Plus icon" data-size="line"> **Add project**.
...
5. Check the [role type](/administer/manage-users-and-access/set-permissions-and-roles-rbac/see-available-roles.md) and change it if needed.
6. Select **Save**.
...
1. Select **Workflow menu** <img src="/files/Zq618vQtJrFswyVCVJ0U" alt="Workflow menu icon" data-size="line"> or **Credential menu** <img src="/files/Zq618vQtJrFswyVCVJ0U" alt="Workflow menu icon" data-size="line"> > **Move**.<br>
