---
title: Dockerfile
url: https://docs.apify.com/actors/development/actor-definition/dockerfile.md
parents:
...
previous: [Web server schema](https://docs.apify.com/actors/development/actor-definition/web-server-schema.md)
next: [Dynamic Actor memory](https://docs.apify.com/actors/development/actor-definition/dynamic-actor-memory.md)
---
...
You can check out various optimization tips for Dockerfile in the [Performance](https://docs.apify.com/actors/development/performance.md) documentation.
