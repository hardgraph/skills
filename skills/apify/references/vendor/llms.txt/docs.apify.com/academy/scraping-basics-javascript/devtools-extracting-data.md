...
url: https://docs.apify.com/academy/scraping-basics-javascript/devtools-extracting-data.md
parents:
...
previous: [DevTools: Locating HTML elements](https://docs.apify.com/academy/scraping-basics-javascript/devtools-locating-elements.md)
next: [Downloading HTML](https://docs.apify.com/academy/scraping-basics-javascript/downloading-html.md)
---
