...
url: https://docs.apify.com/academy/anti-scraping.md
parents:
...
previous: [Custom queries](https://docs.apify.com/academy/api-scraping/graphql-scraping/custom-queries.md)
next: [Anti-scraping techniques](https://docs.apify.com/academy/anti-scraping/techniques.md)
---
...
* Use high-quality proxies. [Residential proxies](https://docs.apify.com/proxy/residential-proxy.md) are the least blocked. You can find many providers out there like Apify, BrightData, Oxylabs, NetNut, etc.
