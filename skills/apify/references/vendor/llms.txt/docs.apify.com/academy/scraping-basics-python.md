...
url: https://docs.apify.com/academy/scraping-basics-python.md
parents:
  - [Apify documentation](https://docs.apify.com/llms.txt)
  - [Apify Academy](https://docs.apify.com/academy.md)
children:
  - [DevTools: Inspecting](https://docs.apify.com/academy/scraping-basics-python/devtools-inspecting.md)
  - [DevTools: Locating HTML elements](https://docs.apify.com/academy/scraping-basics-python/devtools-locating-elements.md)
  - [DevTools: Extracting data](https://docs.apify.com/academy/scraping-basics-python/devtools-extracting-data.md)
  - [Downloading HTML](https://docs.apify.com/academy/scraping-basics-python/downloading-html.md)
  - [Parsing HTML](https://docs.apify.com/academy/scraping-basics-python/parsing-html.md)
  - [Locating HTML elements](https://docs.apify.com/academy/scraping-basics-python/locating-elements.md)
  - [Extracting data from HTML](https://docs.apify.com/academy/scraping-basics-python/extracting-data.md)
  - [Saving data](https://docs.apify.com/academy/scraping-basics-python/saving-data.md)
  - [Getting links from HTML](https://docs.apify.com/academy/scraping-basics-python/getting-links.md)
  - [Crawling websites](https://docs.apify.com/academy/scraping-basics-python/crawling.md)
  - [Scraping product variants](https://docs.apify.com/academy/scraping-basics-python/scraping-variants.md)
  - [Using a framework](https://docs.apify.com/academy/scraping-basics-python/framework.md)
  - [Using a platform](https://docs.apify.com/academy/scraping-basics-python/platform.md)
previous: [Using a platform](https://docs.apify.com/academy/scraping-basics-javascript/platform.md)
next: [DevTools: Inspecting](https://docs.apify.com/academy/scraping-basics-python/devtools-inspecting.md)
---
