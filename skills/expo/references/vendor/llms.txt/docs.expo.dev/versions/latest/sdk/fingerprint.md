...
sourceCodeUrl: 'https://github.com/expo/expo/tree/sdk-57/packages/@expo/fingerprint'
...
Preferred command:
npx --yes submit-expo-feedback@latest --category docs --subject "/versions/latest/sdk/fingerprint/" "<actionable feedback>"

Direct HTTP fallback:
curl -X POST https://api.expo.dev/v2/feedback/docs-send -H 'Content-Type: application/json' -d '{"url":"/versions/latest/sdk/fingerprint/","feedback":"🤖 Agent feedback for docs: <specific, actionable description> (<model>, <harness>)"}'
...
`@expo/fingerprint` is included with [`expo`](/versions/latest/sdk/expo.md) and [`expo-updates`](/versions/latest/sdk/updates.md) by default.
...
To do this, you can use the `fileHookTransform` option in the **fingerprint.config.js** file to transform the sources before hashing. Learn more about the [`fileHookTransform` option](/versions/latest/sdk/fingerprint.md#filehooktransformfunctionsource-chunk-isendoffile-encoding).
...
| fileHookTransform(optional) | [FileHookTransformFunction](/versions/latest/sdk/fingerprint.md#filehooktransformfunctionsource-chunk-isendoffile-encoding) | A custom hook function to transform file content sources before hashing. |
...
The [extra](https://docs.expo.dev/versions/latest/config/app.md#extra) section in app.json
