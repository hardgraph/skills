---
title: API scraping
url: https://docs.apify.com/academy/api-scraping.md
parents:
...
previous: [Scraping iFrames](https://docs.apify.com/academy/puppeteer-playwright/common-use-cases/scraping-iframes.md)
next: [General API scraping](https://docs.apify.com/academy/api-scraping/general-api-scraping.md)
---
