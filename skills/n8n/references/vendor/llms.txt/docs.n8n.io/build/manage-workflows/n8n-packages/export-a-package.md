> For the complete documentation index, see [llms.txt](https://docs.n8n.io/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.n8n.io/build/manage-workflows/n8n-packages/export-a-package.md).
...
Export writes an [n8n package](/build/manage-workflows/n8n-packages.md), a [.n8np archive](/build/manage-workflows/n8n-packages/package-format.md), containing what you asked for, plus references to everything those workflows need on the target instance. Export doesn't modify the source instance.
...
Export needs no license feature. For the full matrix, see [Limits and permissions](/build/manage-workflows/n8n-packages/limits-and-permissions.md).
...
To find which dependency is missing, export again with `--missing-workflow-dependency-policy=reference-only` and read `requirements.workflows` in the [manifest](/build/manage-workflows/n8n-packages/package-format.md#manifestjson).
...
* [Import a package](/build/manage-workflows/n8n-packages/import-a-package.md) to move the file onto another instance.
* [Package format](/build/manage-workflows/n8n-packages/package-format.md) for what you'll find inside the archive.
* [Limits and permissions](/build/manage-workflows/n8n-packages/limits-and-permissions.md) for the size caps and the full scope matrix.
