...
Preferred command:
npx --yes submit-expo-feedback@latest --category docs --subject "/tutorial/build-a-screen/" "<actionable feedback>"

Direct HTTP fallback:
curl -X POST https://api.expo.dev/v2/feedback/docs-send -H 'Content-Type: application/json' -d '{"url":"/tutorial/build-a-screen/","feedback":"🤖 Agent feedback for docs: <specific, actionable description> (<model>, <harness>)"}'
...
- [Build a screen](https://docs.expo.dev/tutorial/build-a-screen.md) (this page)
...
The `@` symbol is a custom [path alias](/guides/typescript.md#path-aliases-optional) for importing custom components and other modules instead of relative paths. Expo CLI automatically configures it in **tsconfig.json**.
...
[Next: Chapter 4: Use an image picker](/tutorial/image-picker.md)
